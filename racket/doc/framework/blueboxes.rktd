72497
((3) 0 () 105 ((q lib "framework/main.rkt") (c (? . 0) q mode:host-text-mixin) (c (? . 0) q mode:surrogate-text%) (c (? . 0) q frame:standard-menus<%>) (c (? . 0) q text:ports<%>) (c (? . 0) q frame:editor-mixin) (c (? . 0) q frame:searchable-text-mixin) (c (? . 0) q color:text<%>) (c (? . 0) q editor:basic<%>) (c (? . 0) q panel:splitter-mixin) (c (? . 0) q frame:searchable-mixin) (c (? . 0) q frame:basic<%>) (c (? . 0) q group:%) (c (? . 0) q frame:register-group-mixin) (c (? . 0) q racket:text<%>) (c (? . 0) q text:basic<%>) (c (? . 0) q text:autocomplete-mixin) (c (? . 0) q editor-snip:decorated<%>) (c (? . 0) q color:text-mixin) (c (? . 0) q text:1-pixel-tab-snip%) (c (? . 0) q text:delegate-mixin) (c (? . 0) q racket:sexp-snip%) (q lib "framework/gui-utils.rkt") (c (? . 0) q frame:editor<%>) (c (? . 0) q text:info-mixin) (c (? . 0) q text:file-mixin) (q lib "framework/test.rkt") (q lib "framework/decorated-editor-snip.rkt") (q lib "framework/splash.rkt") (c (? . 0) q text:first-line-mixin) (c (? . 0) q comment-box:snip%) (c (? . 0) q frame:searchable<%>) (c (? . 0) q frame:delegate-mixin) (c (? . 0) q text:crlf-line-endings-mixin) (c (? . 0) q editor:backup-autosave<%>) (c (? . 0) q text:input-box-mixin) (c (? . 0) q text:searching<%>) (c (? . 0) q frame:info<%>) (c (? . 0) q editor:basic-mixin) (c (? . 0) q text:1-pixel-string-snip%) (c (? . 0) q panel:dragable-mixin) (c (? . 0) q frame:size-pref-mixin) (c (? . 0) q panel:discrete-child<%>) (c (? . 0) q frame:info-mixin) (c (? . 0) q text:searching-mixin) (c (? . 0) q text:wide-snip<%>) (c (? . 0) q text:autocomplete<%>) (c (? . 0) q keymap:aug-keymap<%>) (q lib "framework/preferences.rkt") (c (? . 0) q text:delegate<%>) (c (? . 0) q racket:sexp-snip<%>) (c (? . 0) q canvas:wide-snip<%>) (c (? . 0) q frame:text-info<%>) (c (? . 0) q canvas:info-mixin) (c (? . 0) q text:first-line<%>) (c (? . 0) q editor:file-mixin) (c (? . 0) q frame:basic-mixin) (c (? . 0) q frame:status-line<%>) (c (? . 0) q panel:discrete-sizes<%>) (c (? . 0) q text:line-numbers-mixin) (c (? . 0) q text:normalize-paste-mixin) (c (? . 0) q frame:delegate<%>) (c (? . 0) q frame:status-line-mixin) (c (? . 0) q autosave:autosavable<%>) (c (? . 0) q editor:file<%>) (c (? . 0) q editor-snip:decorated-mixin) (c (? . 0) q canvas:delegate-mixin) (c (? . 0) q frame:text-info-mixin) (c (? . 0) q text:return-mixin) (c (? . 0) q text:foreground-color-mixin) (c (? . 0) q editor:backup-autosave-mixin) (c (? . 0) q menu:can-restore-underscore<%>) (c (? . 0) q color:text-mode-mixin) (c (? . 0) q frame:size-pref<%>) (c (? . 0) q mode:host-text<%>) (c (? . 0) q racket:text-mixin) (c (? . 0) q panel:dragable<%>) (c (? . 0) q editor-snip:decorated-snipclass%) (c (? . 0) q text:line-numbers<%>) (c (? . 0) q text:nbsp->space-mixin) (c (? . 0) q panel:single-mixin) (c (? . 0) q text:file<%>) (c (? . 0) q editor:keymap<%>) (c (? . 0) q number-snip:snip-class%) (c (? . 0) q text:clever-file-format-mixin) (c (? . 0) q text:basic-mixin) (c (? . 0) q text:hide-caret/selection-mixin) (c (? . 0) q keymap:aug-keymap-mixin) (c (? . 0) q text:normalize-paste<%>) (c (? . 0) q mode:surrogate-text<%>) (c (? . 0) q text:ports-mixin) (c (? . 0) q frame:pasteboard-mixin) (c (? . 0) q menu:can-restore<%>) (q lib "framework/framework-sig.rkt") (c (? . 0) q racket:text-mode-mixin) (c (? . 0) q frame:focus-table-mixin) (c (? . 0) q frame:text-mixin) (c (? . 0) q panel:horizontal-dragable-mixin) (c (? . 0) q editor:info-mixin) (c (? . 0) q panel:single-window-mixin) (c (? . 0) q panel:single<%>) (c (? . 0) q editor-snip:decorated%) (c (? . 0) q panel:vertical-dragable-mixin) (c (? . 0) q canvas:wide-snip-mixin) (c (? . 0) q frame:standard-menus-mixin)) () (h ! (equal) ((c meth c (c (? . 1) q can-insert?)) q (102607 . 5)) ((c form c (c (? . 0) q scheme:init-wordbreak-map)) q (163919 . 2)) ((c meth c (c (? . 55) q set-filename)) q (19908 . 5)) ((c meth c (c (? . 2) q after-save-file)) q (94768 . 7)) ((c def c (c (? . 0) q icon:get-up/down-cursor)) q (80512 . 2)) ((c def c (c (? . 22) q gui-utils:unsaved-warning)) q (76007 . 14)) ((c meth c (c (? . 17) q reset-min-sizes)) q (13514 . 2)) ((c meth c (c (? . 7) q skip-whitespace)) q (8626 . 8)) ((c def c (c (? . 0) q canvas:basic<%>)) q (473 . 3)) ((c meth c (c (? . 1) q can-set-size-constraint?)) q (102757 . 2)) ((c meth c (c (? . 3) q edit-menu:get-select-all-item)) q (47592 . 3)) ((c meth c (c (? . 44) q after-insert)) q (137096 . 5)) ((c meth c (c (? . 64) q update-frame-filename)) q (19514 . 2)) ((c def c (? . 13)) q (31332 . 4)) ((c meth c (c (? . 2) q on-paint)) q (89455 . 23)) ((c meth c (c (? . 3) q edit-menu:create-undo?)) q (43028 . 3)) ((c meth c (c (? . 3) q edit-menu:get-copy-item)) q (45177 . 3)) ((q def ((lib "framework/framework-unit.rkt") framework@)) q (164348 . 2)) ((c def c (c (? . 0) q text:searching%)) q (155073 . 3)) ((c meth c (c (? . 4) q clear-input-port)) q (150754 . 2)) ((c meth c (c (? . 30) q get-text)) q (12737 . 2)) ((c meth c (c (? . 3) q edit-menu:create-select-all?)) q (47706 . 3)) ((c meth c (c (? . 31) q search)) q (65562 . 3)) ((c meth c (c (? . 4) q clear-box-input-port)) q (150811 . 2)) ((c meth c (c (? . 9) q collapse)) q (109386 . 3)) ((c def c (c (? . 0) q text:line-spacing-mixin)) q (131115 . 4)) ((c meth c (c (? . 10) q edit-menu:find-callback)) q (67092 . 2)) ((c def c (? . 38)) q (16977 . 4)) ((c meth c (c (? . 3) q edit-menu:undo-callback)) q (43105 . 6)) ((c def c (c (? . 0) q preferences:add-scheme-checkbox-panel)) q (113638 . 2)) ((c meth c (c (? . 4) q after-io-insertion)) q (151464 . 2)) ((c def c (c (? . 0) q exit:user-oks-exit)) q (22645 . 2)) ((c meth c (c (? . 6) q get-editor<%>)) q (69062 . 3)) ((c meth c (c (? . 5) q file-menu:create-print?)) q (62859 . 2)) ((c meth c (c (? . 37) q determine-width)) q (32593 . 7)) ((c meth c (c (? . 1) q on-set-size-constraint)) q (101389 . 2)) ((c meth c (c (? . 88) q string-normalize)) q (134827 . 3)) ((c def c (? . 65)) q (13582 . 4)) ((c meth c (c (? . 3) q help-menu:after-about)) q (56898 . 4)) ((c def c (? . 40)) q (106878 . 5)) ((c meth c (c (? . 14) q tabify-all)) q (120871 . 2)) ((c meth c (c (? . 33) q after-load-file)) q (148531 . 4)) ((c meth c (c (? . 29) q scroll-editor-to)) q (132667 . 13)) ((c meth c (c (? . 12) q remove-frame)) q (72841 . 3)) ((c def c (c (? . 0) q menu:can-restore-menu-item%)) q (85192 . 3)) ((c meth c (c (? . 5) q on-close)) q (61305 . 2)) ((c def c (? . 18)) q (10506 . 4)) ((c def c (c (? . 0) q editor:get-default-color-style-name)) q (21642 . 2)) ((c def c (c (? . 0) q text:range-caret-space?)) q (156282 . 3)) ((c def c (c (? . 0) q frame:register-group<%>)) q (31283 . 2)) ((c meth c (c (? . 15) q unhighlight-ranges/key)) q (127822 . 3)) ((c def c (c (? . 0) q finder:std-get-file)) q (25301 . 12)) ((c def c (c (? . 0) q canvas:info%)) q (2375 . 3)) ((c def c (? . 8)) q (14979 . 3)) ((c meth c (c (? . 67) q on-close)) q (34568 . 2)) ((c def c (c (? . 0) q preferences:add-to-editor-checkbox-panel)) q (113955 . 3)) ((c form c (c (? . 27) q decorated-editor-snipclass%)) q (12950 . 2)) ((c meth c (c (? . 54) q first-line-currently-drawn-specially?)) q (131424 . 3)) ((c meth c (c (? . 11) q editing-this-file?)) q (28307 . 3)) ((c meth c (c (? . 1) q on-default-event)) q (98757 . 3)) ((c meth c (c (? . 23) q get-canvas<%>)) q (57600 . 2)) ((c def c (c (? . 0) q text:return%)) q (154595 . 3)) ((c meth c (c (? . 3) q file-menu:get-save-as-item)) q (39545 . 3)) ((c def c (? . 6)) q (68770 . 5)) ((c meth c (c (? . 56) q show)) q (28745 . 3)) ((c def c (c (? . 26) q test:set-check-box!)) q (160992 . 4)) ((c meth c (c (? . 7) q reset-regions)) q (8060 . 3)) ((c meth c (c (? . 8) q close)) q (16451 . 2)) ((c meth c (c (? . 9) q split-vertical)) q (108868 . 7)) ((c meth c (c (? . 19) q draw)) q (142958 . 21)) ((c meth c (c (? . 20) q resized)) q (146049 . 5)) ((c meth c (c (? . 10) q edit-menu:create-find-again-backwards?)) q (67851 . 3)) ((c def c (c (? . 0) q text:autocomplete-limit)) q (156692 . 4)) ((c meth c (c (? . 16) q on-paint)) q (153444 . 2)) ((c def c (c (? . 0) q finder:common-put-file)) q (23216 . 17)) ((c def c (? . 91)) q (63991 . 4)) ((c def c (c (? . 0) q handler:add-to-recent)) q (79705 . 3)) ((c def c (? . 50)) q (117587 . 2)) ((c def c (c (? . 0) q icon:get-eof-bitmap)) q (80157 . 2)) ((c meth c (c (? . 11) q get-menu-bar%)) q (27932 . 2)) ((c meth c (c (? . 2) q on-new-image-snip)) q (88899 . 14)) ((c meth c (c (? . 82) q get-keymaps)) q (18879 . 3)) ((c meth c (c (? . 10) q edit-menu:create-find-again?)) q (67458 . 3)) ((c form c (c (? . 0) q scheme:get-wordbreak-map)) q (163887 . 2)) ((c def c (c (? . 0) q frame:delegate%)) q (70171 . 3)) ((c meth c (c (? . 47) q get-map-function-table)) q (80851 . 2)) ((c meth c (c (? . 3) q edit-menu:preferences-string)) q (55792 . 3)) ((c meth c (c (? . 81) q while-unlocked)) q (148790 . 3)) ((c meth c (c (? . 3) q edit-menu:create-replace-all?)) q (53440 . 3)) ((c def c (c (? . 0) q canvas:color<%>)) q (687 . 3)) ((c form c (c (? . 0) q scheme:add-preferences-panel)) q (164004 . 2)) ((c meth c (c (? . 12) q clear)) q (72937 . 2)) ((c def c (? . 41)) q (29681 . 4)) ((c meth c (c (? . 5) q get-filename)) q (61141 . 2)) ((c meth c (c (? . 13) q can-close?)) q (31489 . 2)) ((c meth c (c (? . 14) q uncomment-selection)) q (121418 . 5)) ((c def c (c (? . 0) q pasteboard:backup-autosave%)) q (111944 . 3)) ((c def c (c (? . 0) q text:input-box%)) q (154401 . 3)) ((c def c (? . 71)) q (84766 . 3)) ((c meth c (c (? . 15) q move/copy-to-edit)) q (128606 . 13)) ((c meth c (c (? . 16) q on-event)) q (153555 . 2)) ((c def c (c (? . 0) q keymap:set-chained-keymaps)) q (83874 . 5)) ((c meth c (c (? . 3) q file-menu:between-revert-and-save)) q (38724 . 4)) ((c def c (c (? . 0) q editor:info<%>)) q (21260 . 3)) ((c meth c (c (? . 3) q file-menu:open-recent-on-demand)) q (37528 . 4)) ((c meth c (c (? . 1) q on-delete)) q (101066 . 4)) ((c meth c (c (? . 3) q edit-menu:redo-callback)) q (43778 . 6)) ((c def c (c (? . 0) q path-utils:generate-backup-name)) q (112247 . 3)) ((c meth c (c (? . 3) q edit-menu:get-clear-item)) q (46781 . 3)) ((c meth c (c (? . 3) q edit-menu:get-find-from-selection-item)) q (49190 . 3)) ((c def c (c (? . 0) q preferences:add-warnings-checkbox-panel)) q (113575 . 2)) ((c meth c (c (? . 7) q insert-close-paren)) q (9558 . 11)) ((c def c (c (? . 0) q exit:exiting?)) q (22232 . 2)) ((c meth c (c (? . 80) q place-children)) q (104783 . 3)) ((c meth c (c (? . 11) q make-root-area-container)) q (28006 . 6)) ((c meth c (c (? . 10) q edit-menu:find-again-backwards-callback)) q (67537 . 7)) ((c def c (? . 17)) q (13052 . 3)) ((c def c (c (? . 0) q panel:vertical-dragable<%>)) q (106702 . 3)) ((c meth c (c (? . 24) q after-insert)) q (147547 . 4)) ((c meth c (c (? . 3) q file-menu:close-string)) q (41832 . 2)) ((c meth c (c (? . 4) q get-out-style-delta)) q (150872 . 3)) ((c def c (c (? . 0) q racket:short-sym->style-name)) q (125556 . 3)) ((c meth c (c (? . 3) q edit-menu:get-redo-item)) q (43593 . 3)) ((c def c (c (? . 0) q menu:can-restore-underscore-mixin)) q (85014 . 4)) ((c meth c (c (? . 36) q get-replace-search-hit)) q (136337 . 3)) ((c meth c (c (? . 14) q comment-out-selection)) q (121234 . 5)) ((c meth c (c (? . 14) q select-down-sexp)) q (123010 . 2)) ((c meth c (c (? . 18) q lock)) q (10642 . 2)) ((c def c (? . 7)) q (5973 . 3)) ((c def c (? . 11)) q (27689 . 3)) ((c meth c (c (? . 34) q backup?)) q (20296 . 2)) ((c meth c (c (? . 19) q copy)) q (141771 . 2)) ((c meth c (c (? . 8) q run-after-edit-sequence)) q (15171 . 5)) ((c meth c (c (? . 21) q write)) q (118178 . 3)) ((c meth c (c (? . 2) q on-event)) q (87204 . 7)) ((c def c (c (? . 0) q canvas:color%)) q (2292 . 3)) ((c def c (c (? . 0) q keymap:add-user-keybindings-file)) q (81854 . 4)) ((c def c (c (? . 48) q exn:unknown-preference?)) q (116751 . 3)) ((c def c (c (? . 0) q canvas:color-mixin)) q (761 . 4)) ((c meth c (c (? . 2) q after-insert)) q (93449 . 9)) ((c meth c (c (? . 25) q can-insert?)) q (149058 . 4)) ((c meth c (c (? . 1) q on-display-size)) q (98843 . 2)) ((c def c (c (? . 28) q get-splash-height)) q (160274 . 2)) ((c meth c (c (? . 3) q edit-menu:create-paste?)) q (46084 . 3)) ((c meth c (c (? . 43) q make-root-area-container)) q (33629 . 6)) ((c meth c (c (? . 5) q can-close?)) q (61356 . 2)) ((c meth c (c (? . 20) q highlight-range)) q (143934 . 14)) ((c def c (c (? . 0) q text:keymap%)) q (154500 . 3)) ((c def c (? . 10)) q (66934 . 4)) ((c meth c (c (? . 21) q get-extent)) q (119019 . 22)) ((c meth c (c (? . 7) q force-stop-colorer)) q (7475 . 3)) ((c meth c (c (? . 100) q active-child)) q (104299 . 4)) ((c def c (c (? . 22) q gui-utils:cancel-on-right?)) q (74317 . 2)) ((c meth c (c (? . 2) q can-insert?)) q (95774 . 9)) ((c meth c (c (? . 21) q get-text)) q (117837 . 7)) ((c def c (c (? . 0) q frame:lookup-focus-table)) q (71946 . 4)) ((c meth c (c (? . 23) q get-entire-label)) q (57310 . 2)) ((c meth c (c (? . 14) q tabify-selection)) q (120623 . 5)) ((c meth c (c (? . 10) q edit-menu:create-replace-all?)) q (68130 . 3)) ((c form c (c (? . 0) q scheme:text-balanced?)) q (164243 . 2)) ((c meth c (c (? . 1) q can-change-style?)) q (102295 . 5)) ((c meth c (c (? . 3) q edit-menu:between-clear-and-select-all)) q (47461 . 4)) ((c def c (? . 96)) q (63594 . 4)) ((c def c (c (? . 0) q handler:install-recent-items)) q (79486 . 3)) ((c meth c (c (? . 24) q after-delete)) q (147691 . 4)) ((c def c (c (? . 0) q icon:get-anchor-bitmap)) q (80390 . 2)) ((c meth c (c (? . 3) q edit-menu:find-next-string)) q (50687 . 3)) ((c def c (? . 25)) q (148877 . 5)) ((c meth c (c (? . 1) q on-paint)) q (99890 . 19)) ((c form c (c (? . 0) q scheme:set-mode-mixin)) q (163806 . 2)) ((c def c (c (? . 0) q frame:searchable%)) q (70052 . 4)) ((c meth c (c (? . 3) q edit-menu:create-copy?)) q (45285 . 3)) ((c def c (c (? . 26) q test:set-radio-box-item!)) q (160898 . 3)) ((c def c (c (? . 0) q panel:vertical-discrete-sizes%)) q (110261 . 3)) ((c def c (? . 16)) q (153302 . 4)) ((c def c (c (? . 0) q exit:can-exit?)) q (22537 . 2)) ((c def c (c (? . 0) q group:create-windows-menu)) q (73445 . 3)) ((c meth c (c (? . 7) q reset-region)) q (7919 . 4)) ((c meth c (c (? . 5) q help-menu:about-string)) q (63387 . 2)) ((c constructor c (? . 72)) q (11360 . 10)) ((c meth c (c (? . 8) q get-top-level-window)) q (15374 . 3)) ((c def c (? . 62)) q (32144 . 4)) ((c form c (c (? . 27) q decorated-editor-snip<%>)) q (13020 . 2)) ((c meth c (c (? . 3) q edit-menu:clear-on-demand)) q (47187 . 4)) ((c meth c (c (? . 14) q remove-parens-forward)) q (122732 . 3)) ((c meth c (c (? . 3) q file-menu:get-open-item)) q (36412 . 3)) ((c def c (c (? . 0) q pasteboard:file%)) q (111854 . 3)) ((c def c (? . 85)) q (129679 . 5)) ((c meth c (c (? . 9) q split-horizontal)) q (109125 . 7)) ((c meth c (c (? . 3) q edit-menu:get-find-previous-item)) q (50852 . 3)) ((c meth c (c (? . 39) q get-extent)) q (139104 . 22)) ((c meth c (c (? . 32) q get-editor<%>)) q (65344 . 2)) ((c def c (c (? . 0) q keymap:call/text-keymap-initializer)) q (82729 . 3)) ((c def c (c (? . 0) q editor:autowrap<%>)) q (19104 . 3)) ((c meth c (c (? . 20) q after-change-style)) q (146614 . 5)) ((c def c (c (? . 0) q path-utils:generate-autosave-name)) q (112153 . 3)) ((c meth c (c (? . 14) q get-backward-sexp)) q (121997 . 4)) ((c meth c (c (? . 77) q read)) q (14823 . 4)) ((c meth c (c (? . 3) q edit-menu:cut-on-demand)) q (44786 . 4)) ((c meth c (c (? . 5) q file-menu:create-save?)) q (62302 . 2)) ((c def c (c (? . 0) q exit:set-exiting)) q (22272 . 3)) ((c meth c (c (? . 104) q on-close)) q (57169 . 2)) ((c def c (c (? . 28) q set-splash-paint-callback)) q (159414 . 8)) ((c meth c (c (? . 49) q set-delegate)) q (138537 . 3)) ((c meth c (c (? . 3) q edit-menu:find-case-sensitive-string)) q (54828 . 3)) ((c meth c (c (? . 3) q file-menu:print-callback)) q (40645 . 6)) ((c meth c (c (? . 5) q help-menu:about-callback)) q (63180 . 5)) ((c meth c (c (? . 7) q backward-containing-sexp)) q (9126 . 6)) ((c meth c (c (? . 23) q get-editor<%>)) q (57755 . 2)) ((c meth c (c (? . 35) q on-default-char)) q (152438 . 3)) ((c form c (c (? . 0) q scheme:short-sym->pref-name)) q (164172 . 2)) ((c meth c (c (? . 42) q get-discrete-heights)) q (109860 . 3)) ((c def c (c (? . 22) q gui-utils:show-busy-cursor)) q (75360 . 4)) ((c def c (c (? . 0) q menu:can-restore-underscore-menu%)) q (85408 . 3)) ((c meth c (c (? . 60) q do-paste)) q (135073 . 5)) ((c meth c (c (? . 2) q on-new-box)) q (88634 . 7)) ((c meth c (c (? . 10) q edit-menu:find-case-sensitive-on-demand)) q (68299 . 4)) ((c def c (? . 73)) q (29516 . 3)) ((c meth c (c (? . 59) q show-line-numbers!)) q (155773 . 3)) ((c def c (? . 29)) q (131678 . 4)) ((c meth c (c (? . 52) q set-macro-recording)) q (33999 . 3)) ((c def c (c (? . 0) q canvas:delegate%)) q (2456 . 3)) ((c def c (c (? . 0) q keymap:region-click)) q (84292 . 5)) ((c def c (c (? . 0) q canvas:basic-mixin)) q (546 . 4)) ((c meth c (c (? . 30) q get-menu)) q (12793 . 2)) ((c meth c (c (? . 31) q replace-all)) q (65739 . 2)) ((c def c (c (? . 0) q panel:discrete-sizes-mixin)) q (109963 . 5)) ((c meth c (c (? . 1) q on-edit-sequence)) q (98901 . 2)) ((c meth c (c (? . 58) q get-orientation)) q (109640 . 2)) ((c meth c (c (? . 45) q add-tall-snip)) q (138146 . 3)) ((c def c (c (? . 0) q text:standard-style-list%)) q (154290 . 3)) ((c def c (? . 32)) q (64926 . 5)) ((c def c (c (? . 28) q add-splash-icon)) q (158636 . 5)) ((c meth c (c (? . 7) q is-stopped?)) q (7564 . 2)) ((c def c (c (? . 0) q color-model:xyz-x)) q (3414 . 3)) ((c meth c (c (? . 3) q edit-menu:find-on-demand)) q (48919 . 4)) ((c meth c (c (? . 10) q edit-menu:find-again-callback)) q (67237 . 6)) ((c meth c (c (? . 2) q on-change)) q (85801 . 5)) ((c meth c (c (? . 3) q edit-menu:show/hide-replace-help-string)) q (52447 . 3)) ((c def c (c (? . 0) q keymap:setup-editor)) q (83536 . 3)) ((c meth c (c (? . 3) q edit-menu:preferences-on-demand)) q (55658 . 4)) ((c meth c (c (? . 7) q start-colorer)) q (6043 . 22)) ((c meth c (c (? . 1) q on-char)) q (98595 . 3)) ((c form c (c (? . 0) q scheme:short-sym->style-name)) q (164207 . 2)) ((c def c (c (? . 0) q text:nbsp->space%)) q (153908 . 3)) ((c def c (c (? . 0) q handler:open-file)) q (79349 . 4)) ((c def c (c (? . 0) q icon:get-unlock-bitmap)) q (80331 . 2)) ((c def c (c (? . 26) q test:number-pending-actions)) q (162796 . 2)) ((c def c (? . 33)) q (148379 . 4)) ((c meth c (c (? . 12) q can-close-all?)) q (73031 . 2)) ((c meth c (c (? . 7) q thaw-colorer)) q (7728 . 5)) ((c def c (? . 95)) q (29239 . 4)) ((c meth c (c (? . 3) q edit-menu:create-find-from-selection?)) q (49313 . 3)) ((c meth c (c (? . 34) q autosave?)) q (20360 . 2)) ((c def c (? . 35)) q (152302 . 4)) ((c def c (c (? . 0) q exit:insert-can?-callback)) q (22440 . 3)) ((c def c (c (? . 0) q group:add-to-windows-menu)) q (73351 . 3)) ((c meth c (c (? . 3) q edit-menu:show/hide-replace-on-demand)) q (52219 . 4)) ((c meth c (c (? . 3) q file-menu:get-save-item)) q (38850 . 3)) ((c meth c (c (? . 3) q file-menu:close-callback)) q (41473 . 6)) ((c meth c (c (? . 2) q on-delete)) q (91452 . 9)) ((c meth c (c (? . 3) q file-menu:save-string)) q (39391 . 2)) ((c meth c (c (? . 18) q after-set-position)) q (10796 . 2)) ((c def c (c (? . 0) q pasteboard:keymap%)) q (111747 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-all-callback)) q (53524 . 7)) ((c def c (c (? . 0) q menu:can-restore-mixin)) q (84608 . 4)) ((c def c (c (? . 26) q test:set-radio-box!)) q (160732 . 4)) ((c meth c (c (? . 2) q on-local-char)) q (88081 . 7)) ((c def c (c (? . 0) q keymap:get-editor)) q (82948 . 2)) ((c meth c (c (? . 102) q get-vertical?)) q (108071 . 2)) ((c def c (? . 24)) q (147152 . 5)) ((c def c (c (? . 0) q icon:get-autowrap-bitmap)) q (80213 . 2)) ((c meth c (c (? . 36) q set-search-anchor)) q (136161 . 3)) ((c meth c (c (? . 10) q edit-menu:create-find?)) q (67165 . 2)) ((c def c (c (? . 0) q preferences:add-general-checkbox-panel)) q (113513 . 2)) ((c meth c (c (? . 37) q get-info-editor)) q (33170 . 3)) ((c meth c (c (? . 38) q after-edit-sequence)) q (17619 . 2)) ((c def c (? . 89)) q (85518 . 2)) ((c meth c (c (? . 36) q get-search-hit-count)) q (136270 . 2)) ((c meth c (c (? . 57) q open-status-line)) q (31778 . 3)) ((c meth c (c (? . 14) q box-comment-out-selection)) q (120978 . 6)) ((c meth c (c (? . 3) q edit-menu:copy-string)) q (45696 . 2)) ((c meth c (c (? . 1) q on-insert)) q (101168 . 4)) ((c meth c (c (? . 39) q copy)) q (139034 . 2)) ((c def c (c (? . 0) q text:range?)) q (156035 . 3)) ((c meth c (c (? . 61) q set-delegated-text)) q (64554 . 3)) ((c def c (c (? . 0) q racket:text-balanced?)) q (124928 . 5)) ((c meth c (c (? . 7) q get-spell-current-dict)) q (8449 . 2)) ((c def c (c (? . 0) q menu:can-restore-checkable-menu-item%)) q (85290 . 3)) ((c meth c (c (? . 2) q on-display-size)) q (86808 . 5)) ((c meth c (c (? . 3) q file-menu:between-close-and-quit)) q (41988 . 4)) ((c def c (c (? . 0) q canvas:delegate<%>)) q (903 . 3)) ((c form c (c (? . 27) q decorated-editor-snip-mixin)) q (12985 . 2)) ((c meth c (c (? . 3) q edit-menu:paste-callback)) q (46162 . 6)) ((c meth c (c (? . 10) q make-root-area-container)) q (68504 . 3)) ((c meth c (c (? . 40) q place-children)) q (107384 . 8)) ((c def c (c (? . 26) q test:menu-select)) q (161772 . 4)) ((c def c (c (? . 0) q color-model:rgb->xyz)) q (2636 . 5)) ((c meth c (c (? . 41) q on-size)) q (30899 . 5)) ((c meth c (c (? . 3) q edit-menu:find-case-sensitive-on-demand)) q (54696 . 4)) ((c def c (c (? . 0) q canvas:wide-snip%)) q (2545 . 3)) ((c def c (c (? . 0) q keymap:remove-user-keybindings-file)) q (81737 . 4)) ((c meth c (c (? . 3) q file-menu:after-quit)) q (42808 . 3)) ((c def c (? . 53)) q (1298 . 4)) ((c meth c (c (? . 2) q on-snip-modified)) q (90713 . 9)) ((c meth c (c (? . 51) q add-wide-snip)) q (1677 . 3)) ((c meth c (c (? . 20) q after-edit-sequence)) q (145986 . 2)) ((c meth c (c (? . 6) q get-text-to-search)) q (68980 . 3)) ((c def c (? . 42)) q (109709 . 2)) ((c meth c (c (? . 1) q after-save-file)) q (102204 . 3)) ((c meth c (c (? . 15) q unhighlight-ranges)) q (127908 . 10)) ((c meth c (c (? . 14) q tabify)) q (120492 . 3)) ((c def c (? . 63)) q (123 . 2)) ((c meth c (c (? . 2) q can-set-size-constraint?)) q (96123 . 7)) ((c def c (? . 43)) q (33492 . 4)) ((c meth c (c (? . 20) q after-delete)) q (146420 . 5)) ((c meth c (c (? . 2) q after-delete)) q (93096 . 9)) ((c meth c (c (? . 3) q edit-menu:find-next-help-string)) q (50767 . 3)) ((c meth c (c (? . 14) q tabify-on-return?)) q (120430 . 2)) ((c meth c (c (? . 12) q get-mdi-parent)) q (72151 . 3)) ((c def c (c (? . 0) q handler:handler-extension)) q (78006 . 4)) ((c meth c (c (? . 3) q file-menu:save-as-help-string)) q (40247 . 3)) ((c meth c (c (? . 11) q get-filename)) q (28403 . 3)) ((c def c (? . 46)) q (152541 . 3)) ((c form c (c (? . 0) q scheme:text%)) q (163704 . 2)) ((c meth c (c (? . 44) q get-keymaps)) q (137016 . 3)) ((c meth c (c (? . 3) q edit-menu:create-find-case-sensitive?)) q (54265 . 3)) ((c def c (c (? . 0) q handler:set-recent-position)) q (79783 . 7)) ((c def c (c (? . 0) q text:nbsp->space<%>)) q (134077 . 3)) ((c meth c (c (? . 11) q make-visible)) q (28525 . 3)) ((c def c (c (? . 0) q frame:pasteboard%)) q (70262 . 3)) ((c def c (c (? . 0) q panel:horizontal-discrete-sizes%)) q (110158 . 3)) ((c meth c (c (? . 45) q add-wide-snip)) q (138052 . 3)) ((c def c (c (? . 0) q exit:on-exit)) q (22578 . 2)) ((c meth c (c (? . 46) q completion-mode-key-event?)) q (152998 . 4)) ((c def c (c (? . 0) q group:get-the-frame-group)) q (73196 . 2)) ((c meth c (c (? . 3) q file-menu:get-print-item)) q (40458 . 3)) ((c meth c (c (? . 83) q read)) q (103670 . 4)) ((c meth c (c (? . 47) q get-map-function-table/ht)) q (80921 . 3)) ((c meth c (c (? . 78) q show-line-numbers?)) q (155407 . 2)) ((c def c (c (? . 0) q text:wide-snip-mixin)) q (138240 . 4)) ((c def c (c (? . 26) q test:run-interval)) q (162237 . 4)) ((c def c (c (? . 0) q pasteboard:standard-style-list%)) q (111628 . 3)) ((c meth c (c (? . 3) q edit-menu:cut-string)) q (44902 . 2)) ((c meth c (c (? . 3) q file-menu:create-print?)) q (40567 . 3)) ((c def c (? . 92)) q (84457 . 3)) ((c def c (c (? . 48) q preferences:add-callback)) q (115155 . 6)) ((c meth c (c (? . 90) q can-delete?)) q (151960 . 4)) ((c meth c (c (? . 23) q get-editor)) q (58321 . 2)) ((c def c (c (? . 0) q keymap:remove-chained-keymap)) q (84100 . 5)) ((c meth c (c (? . 49) q get-delegate)) q (138457 . 3)) ((c meth c (c (? . 12) q on-close-all)) q (72982 . 2)) ((c meth c (c (? . 50) q get-saved-snips)) q (117632 . 3)) ((c meth c (c (? . 94) q on-enable-surrogate)) q (124457 . 2)) ((c meth c (c (? . 1) q put-file)) q (103427 . 5)) ((c meth c (c (? . 7) q forward-match)) q (9353 . 6)) ((c meth c (c (? . 51) q add-tall-snip)) q (1773 . 3)) ((c meth c (c (? . 4) q get-unread-start-point)) q (149830 . 2)) ((c meth c (c (? . 3) q edit-menu:clear-help-string)) q (47380 . 3)) ((c meth c (c (? . 42) q get-discrete-widths)) q (109758 . 3)) ((c def c (c (? . 48) q preferences:restore-prefs-snapshot)) q (117410 . 3)) ((c meth c (c (? . 3) q file-menu:between-open-and-revert)) q (37821 . 4)) ((c meth c (c (? . 52) q add-line-number-menu-items)) q (34296 . 4)) ((c meth c (c (? . 5) q editing-this-file?)) q (61208 . 3)) ((c meth c (c (? . 12) q get-frames)) q (72232 . 3)) ((c meth c (c (? . 53) q set-editor)) q (1488 . 2)) ((c meth c (c (? . 7) q stop-colorer)) q (7369 . 3)) ((c def c (c (? . 26) q test:button-push)) q (160374 . 7)) ((c def c (? . 54)) q (131265 . 3)) ((c meth c (c (? . 3) q file-menu:open-help-string)) q (37027 . 3)) ((c meth c (c (? . 84) q on-save-file)) q (148064 . 5)) ((c meth c (c (? . 5) q file-menu:revert-on-demand)) q (61749 . 2)) ((c meth c (c (? . 12) q frame-shown/hidden)) q (72414 . 2)) ((c meth c (c (? . 55) q get-keymaps)) q (20133 . 3)) ((c meth c (c (? . 3) q edit-menu:find-help-string)) q (49110 . 3)) ((c meth c (c (? . 56) q on-exit)) q (28871 . 2)) ((c def c (? . 51)) q (1540 . 3)) ((c def c (c (? . 0) q frame:focus-table<%>)) q (29156 . 3)) ((c def c (c (? . 22) q gui-utils:get-choice)) q (76539 . 22)) ((c meth c (c (? . 57) q close-status-line)) q (31865 . 3)) ((c def c (c (? . 0) q color-model:xyz-y)) q (3491 . 3)) ((c meth c (c (? . 46) q get-all-words)) q (153127 . 2)) ((c meth c (c (? . 14) q find-down-sexp)) q (122523 . 4)) ((c meth c (c (? . 7) q is-frozen?)) q (7619 . 2)) ((c def c (c (? . 28) q refresh-splash)) q (160336 . 2)) ((c meth c (c (? . 3) q edit-menu:get-cut-item)) q (44389 . 3)) ((c meth c (c (? . 1) q on-change)) q (98543 . 2)) ((c def c (? . 58)) q (109482 . 2)) ((c meth c (c (? . 3) q edit-menu:show/hide-replace-string)) q (52359 . 3)) ((c meth c (c (? . 2) q on-char)) q (85986 . 7)) ((c def c (c (? . 0) q autosave:toc-path)) q (380 . 2)) ((c def c (c (? . 48) q preferences:set-default)) q (115419 . 13)) ((c def c (c (? . 0) q text:wide-snip%)) q (154198 . 3)) ((c meth c (c (? . 3) q edit-menu:preferences-help-string)) q (55874 . 3)) ((c meth c (c (? . 3) q file-menu:create-close?)) q (41395 . 3)) ((c def c (c (? . 26) q test:keystroke)) q (161495 . 6)) ((c def c (c (? . 0) q color-model:xyz?)) q (3348 . 3)) ((c def c (c (? . 0) q frame:pasteboard-info%)) q (69578 . 3)) ((c def c (c (? . 0) q handler:handler-name)) q (77918 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-all-on-demand)) q (53839 . 4)) ((c meth c (c (? . 1) q on-save-file)) q (100569 . 5)) ((c def c (c (? . 0) q keymap:setup-file)) q (83621 . 3)) ((c def c (c (? . 28) q set-splash-char-observer)) q (159761 . 3)) ((c meth c (c (? . 3) q get-checkable-menu-item%)) q (35258 . 3)) ((c def c (c (? . 0) q text:autocomplete-append-after)) q (156561 . 4)) ((c def c (c (? . 0) q text:input-box<%>)) q (152236 . 3)) ((c form c (c (? . 0) q scheme:text-mixin)) q (163679 . 2)) ((c meth c (c (? . 40) q after-new-child)) q (107068 . 3)) ((c def c (c (? . 0) q text:hide-caret/selection%)) q (153794 . 3)) ((c meth c (c (? . 56) q on-drop-file)) q (29010 . 3)) ((c meth c (c (? . 3) q edit-menu:create-find-previous?)) q (50969 . 3)) ((c def c (c (? . 0) q text:backup-autosave%)) q (154961 . 3)) ((c meth c (c (? . 3) q file-menu:save-on-demand)) q (39264 . 4)) ((c def c (c (? . 0) q preferences:add-font-panel)) q (114210 . 2)) ((c form c (c (? . 27) q decorated-editor-snip%)) q (12920 . 2)) ((c meth c (c (? . 2) q on-new-string-snip)) q (92134 . 6)) ((c meth c (c (? . 59) q on-paint)) q (155717 . 2)) ((c def c (c (? . 0) q exit:insert-on-callback)) q (22348 . 3)) ((c meth c (c (? . 11) q close)) q (28260 . 2)) ((c def c (? . 12)) q (72101 . 3)) ((c meth c (c (? . 1) q on-local-char)) q (99276 . 3)) ((c form c (c (? . 0) q scheme:get-keymap)) q (163952 . 2)) ((c meth c (c (? . 24) q set-overwrite-mode)) q (147408 . 3)) ((c meth c (c (? . 36) q set-replace-start)) q (136419 . 3)) ((c meth c (c (? . 69) q default-style-name)) q (133598 . 2)) ((c def c (? . 60)) q (134917 . 4)) ((c meth c (c (? . 5) q file-menu:between-save-as-and-print)) q (62928 . 4)) ((c meth c (c (? . 1) q after-delete)) q (101618 . 5)) ((c meth c (c (? . 3) q edit-menu:create-redo?)) q (43701 . 3)) ((c meth c (c (? . 37) q get-info-panel)) q (33254 . 3)) ((c def c (c (? . 0) q exit:exit)) q (22614 . 2)) ((c meth c (c (? . 61) q delegated-text-shown?)) q (64670 . 2)) ((c meth c (c (? . 15) q initial-autowrap-bitmap)) q (129218 . 3)) ((c meth c (c (? . 20) q on-load-file)) q (146820 . 5)) ((c meth c (c (? . 3) q edit-menu:create-find?)) q (48613 . 3)) ((c meth c (c (? . 70) q on-close)) q (21034 . 2)) ((c meth c (c (? . 3) q edit-menu:copy-help-string)) q (45770 . 3)) ((c def c (? . 20)) q (143792 . 4)) ((c def c (c (? . 0) q icon:get-paren-highlight-bitmap)) q (80089 . 2)) ((c meth c (c (? . 1) q can-do-edit-operation?)) q (102824 . 7)) ((c constructor c (? . 68)) q (137760 . 4)) ((c meth c (c (? . 34) q remove-autosave)) q (20503 . 2)) ((c meth c (c (? . 14) q get-limit)) q (120227 . 3)) ((c def c (c (? . 28) q get-splash-bitmap)) q (158791 . 2)) ((c def c (c (? . 22) q gui-utils:trim-string)) q (73554 . 7)) ((c def c (? . 74)) q (98162 . 2)) ((c def c (c (? . 0) q text:line-spacing<%>)) q (131038 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-all-help-string)) q (54055 . 3)) ((c form c (c (? . 0) q scheme:setup-keymap)) q (163977 . 2)) ((c meth c (c (? . 8) q get-filename/untitled-name)) q (16503 . 2)) ((c meth c (c (? . 3) q edit-menu:find-case-sensitive-callback)) q (54357 . 7)) ((c meth c (c (? . 3) q help-menu:about-help-string)) q (56817 . 3)) ((c meth c (c (? . 62) q make-root-area-container)) q (32295 . 6)) ((c meth c (c (? . 7) q backward-match)) q (8919 . 6)) ((c meth c (c (? . 2) q can-delete?)) q (95425 . 9)) ((c meth c (c (? . 3) q edit-menu:find-next-on-demand)) q (50565 . 4)) ((c def c (c (? . 0) q canvas:info<%>)) q (1225 . 3)) ((c meth c (c (? . 60) q on-insert)) q (135262 . 5)) ((c meth c (c (? . 14) q introduce-let-ans)) q (123427 . 3)) ((c meth c (c (? . 3) q file-menu:save-as-string)) q (40169 . 3)) ((c def c (c (? . 0) q preferences:add-check)) q (114540 . 11)) ((c meth c (c (? . 14) q get-tab-size)) q (123268 . 2)) ((c def c (c (? . 0) q color-model:rgb-color-distance)) q (2754 . 13)) ((c meth c (c (? . 29) q on-event)) q (132568 . 3)) ((c meth c (c (? . 44) q after-delete)) q (137292 . 5)) ((c def c (? . 66)) q (980 . 4)) ((c def c (c (? . 0) q preferences:hide-dialog)) q (114307 . 2)) ((c def c (c (? . 0) q keymap:get-user)) q (83054 . 2)) ((c def c (? . 9)) q (108670 . 5)) ((c meth c (c (? . 3) q file-menu:between-save-as-and-print)) q (40330 . 4)) ((c def c (c (? . 0) q autosave:restore-autosave-files/gui)) q (414 . 2)) ((c meth c (c (? . 3) q file-menu:quit-help-string)) q (42728 . 3)) ((c meth c (c (? . 3) q file-menu:open-recent-callback)) q (37306 . 6)) ((c def c (c (? . 0) q frame:text%)) q (69973 . 3)) ((c def c (c (? . 0) q handler:insert-format-handler)) q (78273 . 7)) ((c def c (c (? . 48) q preferences:low-level-put-preferences)) q (116877 . 5)) ((c def c (c (? . 0) q keymap:setup-search)) q (83789 . 3)) ((c meth c (c (? . 3) q edit-menu:clear-string)) q (47305 . 2)) ((c meth c (c (? . 5) q file-menu:save-callback)) q (62097 . 5)) ((c meth c (c (? . 56) q can-exit?)) q (28817 . 2)) ((c def c (c (? . 0) q text:line-spacing%)) q (153703 . 3)) ((c meth c (c (? . 63) q do-autosave)) q (172 . 2)) ((c meth c (c (? . 76) q set-percentages)) q (106348 . 3)) ((c def c (c (? . 0) q text:hide-caret/selection<%>)) q (133752 . 3)) ((c meth c (c (? . 37) q is-info-hidden?)) q (33433 . 2)) ((c def c (c (? . 0) q text:clever-file-format%)) q (154859 . 3)) ((c meth c (c (? . 14) q down-sexp)) q (122645 . 3)) ((c meth c (c (? . 16) q on-char)) q (153500 . 2)) ((c def c (c (? . 0) q preferences:add-panel)) q (112767 . 12)) ((c def c (c (? . 0) q text:clever-file-format<%>)) q (147835 . 3)) ((c def c (c (? . 0) q group:can-close-check)) q (73303 . 2)) ((c meth c (c (? . 3) q edit-menu:paste-help-string)) q (46574 . 3)) ((c meth c (c (? . 2) q put-file)) q (97800 . 9)) ((c meth c (c (? . 64) q get-can-close-parent)) q (19403 . 3)) ((c meth c (c (? . 65) q get-menu)) q (13932 . 3)) ((c def c (? . 75)) q (123629 . 7)) ((c meth c (c (? . 66) q on-superwindow-show)) q (1128 . 3)) ((c meth c (c (? . 18) q after-edit-sequence)) q (10736 . 2)) ((c meth c (c (? . 67) q update-info)) q (34622 . 2)) ((c meth c (c (? . 3) q file-menu:print-help-string)) q (41079 . 3)) ((c meth c (c (? . 21) q copy)) q (118104 . 2)) ((c def c (? . 49)) q (138384 . 3)) ((c meth c (c (? . 3) q edit-menu:cut-callback)) q (44571 . 6)) ((c def c (c (? . 0) q racket:get-wordbreak-map)) q (125647 . 2)) ((c def c (? . 68)) q (137630 . 4)) ((c meth c (c (? . 69) q get-fixed-style)) q (133670 . 3)) ((c meth c (c (? . 2) q after-set-size-constraint)) q (94001 . 7)) ((c meth c (c (? . 56) q after-new-child)) q (29099 . 2)) ((c meth c (c (? . 70) q on-save-file)) q (20780 . 5)) ((c meth c (c (? . 4) q get-box-input-text%)) q (151613 . 3)) ((c meth c (c (? . 12) q frame-label-changed)) q (72311 . 3)) ((c meth c (c (? . 3) q edit-menu:find-string)) q (49036 . 2)) ((c def c (c (? . 22) q gui-utils:get-clickback-delta)) q (77721 . 4)) ((c meth c (c (? . 38) q on-edit-sequence)) q (17556 . 2)) ((c meth c (c (? . 71) q erase-underscores)) q (84861 . 2)) ((c meth c (c (? . 38) q on-focus)) q (17478 . 3)) ((c meth c (c (? . 3) q file-menu:revert-string)) q (38565 . 3)) ((c form c (c (? . 0) q scheme:sexp-snip<%>)) q (163860 . 2)) ((c def c (c (? . 0) q application:current-app-name)) q (0 . 4)) ((c meth c (c (? . 57) q update-status-line)) q (31953 . 5)) ((c meth c (c (? . 46) q get-word-at)) q (153200 . 3)) ((c meth c (c (? . 3) q edit-menu:between-redo-and-cut)) q (44266 . 4)) ((c meth c (c (? . 23) q make-editor)) q (57816 . 2)) ((c def c (c (? . 0) q finder:default-extension)) q (22916 . 4)) ((c meth c (c (? . 15) q port-name-matches?)) q (129391 . 3)) ((c meth c (c (? . 38) q after-load-file)) q (17383 . 3)) ((c def c (c (? . 48) q preferences:register-save-callback)) q (116340 . 3)) ((c meth c (c (? . 3) q edit-menu:get-replace-item)) q (52540 . 3)) ((c meth c (c (? . 72) q on-disable-surrogate)) q (11894 . 2)) ((c def c (? . 34)) q (20212 . 3)) ((c meth c (c (? . 3) q edit-menu:undo-help-string)) q (43513 . 3)) ((c meth c (c (? . 19) q split)) q (141468 . 7)) ((c def c (c (? . 0) q number-snip:make-fraction-snip)) q (103993 . 6)) ((c def c (c (? . 0) q keymap:get-file)) q (83002 . 2)) ((c def c (c (? . 0) q frame:info%)) q (69413 . 3)) ((c meth c (c (? . 4) q get-err-port)) q (151342 . 2)) ((c def c (? . 61)) q (64346 . 4)) ((c meth c (c (? . 4) q on-submit)) q (150465 . 2)) ((c meth c (c (? . 8) q on-close)) q (16342 . 2)) ((c def c (c (? . 0) q autosave:register)) q (235 . 4)) ((c meth c (c (? . 3) q file-menu:get-new-item)) q (35602 . 3)) ((c meth c (c (? . 52) q overwrite-status-changed)) q (34090 . 2)) ((c def c (c (? . 26) q test:top-level-focus-window-has?)) q (162683 . 3)) ((c meth c (c (? . 86) q after-set-position)) q (134003 . 2)) ((c def c (c (? . 0) q frame:standard-menus%)) q (69778 . 3)) ((c def c (c (? . 0) q handler:handler-handler)) q (78145 . 4)) ((c meth c (c (? . 1) q on-new-string-snip)) q (101270 . 2)) ((c meth c (c (? . 23) q save-as)) q (58093 . 4)) ((c meth c (c (? . 18) q on-set-size-constraint)) q (10914 . 2)) ((c def c (? . 4)) q (149460 . 2)) ((c def c (c (? . 28) q get-splash-width)) q (160213 . 2)) ((c meth c (c (? . 17) q get-color)) q (13233 . 3)) ((c meth c (c (? . 3) q file-menu:new-string)) q (36137 . 2)) ((c meth c (c (? . 61) q get-delegated-text)) q (64456 . 3)) ((c meth c (c (? . 73) q adjust-size-when-monitor-setup-changes?)) q (29592 . 3)) ((c def c (c (? . 0) q text:file%)) q (154761 . 3)) ((c def c (c (? . 0) q preferences:get-preference/gui)) q (112521 . 6)) ((c def c (c (? . 22) q gui-utils:get-clicked-clickback-delta)) q (77582 . 4)) ((c def c (c (? . 0) q text:info<%>)) q (147083 . 3)) ((c def c (c (? . 22) q gui-utils:format-literal-label)) q (74051 . 8)) ((c meth c (c (? . 30) q get-position)) q (12648 . 3)) ((c meth c (c (? . 3) q edit-menu:undo-on-demand)) q (43322 . 4)) ((c meth c (c (? . 3) q edit-menu:get-find-item)) q (48505 . 3)) ((c def c (c (? . 48) q preferences:get-prefs-snapshot)) q (117517 . 2)) ((c meth c (c (? . 3) q file-menu:create-save-as?)) q (39656 . 3)) ((c def c (c (? . 0) q panel:single-window<%>)) q (104918 . 4)) ((c meth c (c (? . 31) q unhide-search)) q (66126 . 7)) ((c meth c (c (? . 74) q get-surrogate)) q (98205 . 3)) ((c def c (c (? . 0) q color-prefs:add-background-preferences-panel)) q (4704 . 2)) ((c def c (c (? . 26) q enabled-shown-button?)) q (163325 . 3)) ((c def c (? . 14)) q (120094 . 5)) ((c meth c (c (? . 2) q on-load-file)) q (87722 . 9)) ((c meth c (c (? . 3) q edit-menu:find-next-callback)) q (50256 . 7)) ((c meth c (c (? . 3) q edit-menu:copy-callback)) q (45362 . 6)) ((c meth c (c (? . 14) q forward-sexp)) q (121803 . 3)) ((c meth c (c (? . 3) q file-menu:get-quit-item)) q (42113 . 3)) ((c def c (c (? . 0) q racket:short-sym->pref-name)) q (125466 . 3)) ((c def c (c (? . 28) q close-splash)) q (158600 . 2)) ((c def c (? . 44)) q (136823 . 5)) ((c meth c (c (? . 15) q set-styles-fixed)) q (128517 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-all-string)) q (53973 . 3)) ((c def c (c (? . 0) q editor:get-standard-style-list)) q (21952 . 2)) ((c def c (c (? . 0) q preferences:add-editor-checkbox-panel)) q (113452 . 2)) ((c meth c (c (? . 38) q on-new-image-snip)) q (17802 . 10)) ((c meth c (c (? . 15) q get-styles-fixed)) q (128387 . 2)) ((c meth c (c (? . 14) q select-up-sexp)) q (122954 . 2)) ((c meth c (c (? . 1) q on-snip-modified)) q (100733 . 5)) ((c def c (? . 2)) q (85701 . 4)) ((c meth c (c (? . 79) q on-insert)) q (134285 . 5)) ((c def c (? . 15)) q (125892 . 4)) ((c meth c (c (? . 3) q file-menu:create-open?)) q (36520 . 3)) ((c meth c (c (? . 14) q mark-matching-parenthesis)) q (123160 . 3)) ((c form c (c (? . 0) q scheme:sexp-snip%)) q (163835 . 2)) ((c meth c (c (? . 37) q show-info)) q (33333 . 2)) ((c meth c (c (? . 5) q edit-menu:between-select-all-and-find)) q (63053 . 4)) ((c meth c (c (? . 75) q get-start-of-line)) q (124012 . 4)) ((c def c (c (? . 0) q comment-box:snipclass)) q (12865 . 2)) ((c meth c (c (? . 44) q on-focus)) q (137488 . 3)) ((c meth c (c (? . 46) q get-autocomplete-border-color)) q (152671 . 3)) ((c meth c (c (? . 4) q get-out-port)) q (151282 . 2)) ((c meth c (c (? . 1) q on-local-event)) q (99359 . 3)) ((c def c (c (? . 28) q get-splash-canvas)) q (158934 . 2)) ((c def c (c (? . 0) q color-model:xyz-z)) q (3568 . 3)) ((c def c (c (? . 0) q frame:basic%)) q (69222 . 3)) ((c meth c (c (? . 3) q edit-menu:create-preferences?)) q (55259 . 3)) ((c meth c (c (? . 3) q file-menu:create-open-recent?)) q (37222 . 3)) ((c meth c (c (? . 64) q user-saves-or-not-modified?)) q (19653 . 4)) ((c def c (c (? . 0) q preferences:add-to-scheme-checkbox-panel)) q (113828 . 3)) ((c def c (c (? . 0) q number-snip:make-repeating-decimal-snip)) q (103793 . 6)) ((c meth c (c (? . 3) q edit-menu:clear-callback)) q (46968 . 6)) ((c meth c (c (? . 1) q on-focus)) q (99038 . 3)) ((c def c (c (? . 0) q frame:size-pref%)) q (69325 . 3)) ((c meth c (c (? . 76) q get-default-percentages)) q (105877 . 4)) ((c def c (? . 77)) q (14583 . 3)) ((c meth c (c (? . 4) q delete/io)) q (149499 . 4)) ((c meth c (c (? . 46) q get-autocomplete-selected-color)) q (152889 . 3)) ((c def c (c (? . 0) q text:lookup-port-name)) q (156989 . 4)) ((c meth c (c (? . 4) q insert-between)) q (150156 . 3)) ((c meth c (c (? . 76) q right-click-in-gap)) q (106049 . 7)) ((c def c (c (? . 0) q frame:editor%)) q (69882 . 3)) ((c meth c (c (? . 14) q insert-return)) q (120923 . 2)) ((c meth c (c (? . 65) q get-corner-bitmap)) q (13739 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-string)) q (53164 . 3)) ((c meth c (c (? . 31) q set-text-to-search)) q (65873 . 3)) ((c meth c (c (? . 53) q on-focus)) q (1438 . 2)) ((c meth c (c (? . 78) q show-line-numbers!)) q (155313 . 3)) ((c def c (c (? . 0) q keymap:setup-global)) q (83704 . 3)) ((c meth c (c (? . 4) q get-allow-edits)) q (150097 . 2)) ((c meth c (c (? . 3) q edit-menu:replace-on-demand)) q (53034 . 4)) ((c meth c (c (? . 25) q after-save-file)) q (149350 . 2)) ((c def c (c (? . 48) q preferences:set)) q (115058 . 4)) ((c meth c (c (? . 31) q hide-search)) q (66068 . 2)) ((c meth c (c (? . 25) q can-delete?)) q (149204 . 4)) ((c meth c (c (? . 3) q file-menu:open-string)) q (36953 . 2)) ((c meth c (c (? . 3) q edit-menu:create-cut?)) q (44496 . 2)) ((c meth c (c (? . 87) q chain-to-keymap)) q (81159 . 5)) ((c def c (c (? . 0) q text:foreground-color<%>)) q (133252 . 4)) ((c meth c (c (? . 3) q edit-menu:between-paste-and-clear)) q (46655 . 4)) ((c def c (c (? . 0) q text:autowrap%)) q (154675 . 3)) ((c meth c (c (? . 98) q lock)) q (21473 . 3)) ((c def c (c (? . 0) q preferences:put-preferences/gui)) q (112335 . 5)) ((c meth c (c (? . 38) q after-save-file)) q (17288 . 3)) ((c meth c (c (? . 17) q get-menu)) q (13325 . 3)) ((c meth c (c (? . 3) q edit-menu:find-from-selection-help-string)) q (49966 . 3)) ((c meth c (c (? . 3) q file-menu:open-recent-help-string)) q (37734 . 3)) ((c meth c (c (? . 14) q balance-parens)) q (120323 . 3)) ((c def c (c (? . 0) q panel:splitter<%>)) q (108627 . 2)) ((c meth c (c (? . 7) q get-regions)) q (8526 . 3)) ((c def c (c (? . 48) q preferences:snapshot?)) q (117339 . 3)) ((c def c (? . 79)) q (134145 . 4)) ((c meth c (c (? . 3) q edit-menu:preferences-callback)) q (55343 . 7)) ((c meth c (c (? . 3) q file-menu:revert-help-string)) q (38642 . 3)) ((c def c (? . 80)) q (104455 . 4)) ((c meth c (c (? . 4) q set-insertion-point)) q (149740 . 3)) ((c meth c (c (? . 1) q after-set-size-constraint)) q (101983 . 2)) ((c def c (c (? . 0) q color-prefs:build-color-selection-panel)) q (4971 . 13)) ((c meth c (c (? . 5) q file-menu:revert-callback)) q (61818 . 5)) ((c def c (c (? . 0) q handler:size-recently-opened-files)) q (80006 . 3)) ((c meth c (c (? . 15) q get-edition-number)) q (129474 . 3)) ((c meth c (c (? . 4) q get-value-style-delta)) q (151064 . 3)) ((c meth c (c (? . 2) q after-change-style)) q (92737 . 10)) ((c meth c (c (? . 39) q draw)) q (140537 . 21)) ((c def c (c (? . 0) q racket:get-white-on-black-color-prefs-table)) q (125357 . 3)) ((c meth c (c (? . 2) q on-edit-sequence)) q (87005 . 5)) ((c meth c (c (? . 18) q after-insert)) q (10977 . 2)) ((c def c (c (? . 0) q editor:set-standard-style-list-delta)) q (21703 . 5)) ((c def c (? . 81)) q (148633 . 4)) ((c meth c (c (? . 14) q find-up-sexp)) q (122318 . 4)) ((c def c (c (? . 26) q label-of-enabled/shown-button-in-top-level-window?)) q (163218 . 4)) ((c def c (c (? . 26) q test:set-list-box!)) q (161312 . 4)) ((c meth c (c (? . 3) q file-menu:create-save?)) q (38958 . 3)) ((c def c (c (? . 0) q color-model:xyz->rgb)) q (3211 . 5)) ((c meth c (c (? . 1) q after-edit-sequence)) q (102051 . 2)) ((c def c (c (? . 48) q exn:make-unknown-preference)) q (116532 . 6)) ((c def c (c (? . 0) q pasteboard:info%)) q (112054 . 3)) ((c def c (c (? . 26) q test:run-one)) q (162891 . 3)) ((c meth c (c (? . 8) q load-file/gui-error)) q (15942 . 9)) ((c meth c (c (? . 3) q help-menu:get-about-item)) q (56196 . 3)) ((c meth c (c (? . 61) q delegate-moved)) q (64867 . 2)) ((c meth c (c (? . 2) q can-save-file?)) q (97433 . 9)) ((c meth c (c (? . 3) q edit-menu:find-previous-on-demand)) q (51376 . 4)) ((c meth c (c (? . 24) q set-anchor)) q (147335 . 3)) ((c meth c (c (? . 3) q edit-menu:undo-string)) q (43439 . 2)) ((c meth c (c (? . 3) q edit-menu:get-paste-item)) q (45975 . 3)) ((c meth c (c (? . 60) q after-insert)) q (135464 . 5)) ((c def c (c (? . 0) q canvas:basic%)) q (2208 . 3)) ((c def c (? . 82)) q (18804 . 3)) ((c meth c (c (? . 37) q lock-status-changed)) q (32854 . 2)) ((c meth c (c (? . 4) q submit-to-port?)) q (150367 . 3)) ((c def c (c (? . 0) q preferences:add-can-close-dialog-callback)) q (114445 . 3)) ((c def c (c (? . 28) q set-refresh-splash-on-gauge-change?!)) q (160036 . 5)) ((c def c (c (? . 0) q racket:text-mode%)) q (124834 . 3)) ((c def c (c (? . 0) q frame:pasteboard-info<%>)) q (34679 . 3)) ((c constructor c (? . 5)) q (58539 . 44)) ((c def c (c (? . 26) q button-in-top-level-focusd-window?)) q (163415 . 3)) ((c meth c (c (? . 3) q file-menu:revert-callback)) q (38136 . 7)) ((c meth c (c (? . 80) q after-new-child)) q (104599 . 3)) ((c def c (c (? . 0) q preferences:add-to-warnings-checkbox-panel)) q (113699 . 3)) ((c meth c (c (? . 3) q help-menu:about-string)) q (56742 . 2)) ((c def c (? . 83)) q (103600 . 3)) ((c def c (c (? . 0) q keymap:get-search)) q (83160 . 2)) ((c def c (c (? . 0) q frame:status-line%)) q (69682 . 3)) ((c def c (? . 101)) q (14121 . 3)) ((c def c (c (? . 26) q test:current-get-eventspaces)) q (162338 . 4)) ((c def c (c (? . 0) q text:range-end)) q (156190 . 3)) ((c meth c (c (? . 65) q get-color)) q (13840 . 3)) ((c meth c (c (? . 40) q container-size)) q (107736 . 4)) ((c meth c (c (? . 3) q help-menu:about-callback)) q (56383 . 6)) ((c meth c (c (? . 3) q edit-menu:find-callback)) q (48690 . 6)) ((c meth c (c (? . 14) q set-tab-size)) q (123331 . 3)) ((c def c (c (? . 0) q color-prefs:black-on-white)) q (5925 . 2)) ((c meth c (c (? . 3) q file-menu:create-revert?)) q (38057 . 3)) ((c meth c (c (? . 3) q file-menu:print-on-demand)) q (40876 . 4)) ((c meth c (c (? . 3) q edit-menu:select-all-on-demand)) q (48085 . 4)) ((c meth c (c (? . 3) q file-menu:new-help-string)) q (36210 . 3)) ((c def c (c (? . 0) q text:basic%)) q (153611 . 3)) ((c meth c (c (? . 23) q save)) q (57934 . 4)) ((c def c (c (? . 28) q shutdown-splash)) q (158561 . 2)) ((c def c (? . 84)) q (147910 . 4)) ((c meth c (c (? . 85) q after-insert)) q (130700 . 4)) ((c meth c (c (? . 3) q file-menu:save-as-callback)) q (39736 . 7)) ((c meth c (c (? . 36) q set-searching-state)) q (135778 . 10)) ((c meth c (c (? . 2) q can-do-edit-operation?)) q (96402 . 17)) ((c meth c (c (? . 38) q can-save-file?)) q (17113 . 5)) ((c meth c (c (? . 1) q on-load-file)) q (99112 . 5)) ((c def c (c (? . 0) q keymap:make-meta-prefix-list)) q (83214 . 3)) ((c def c (c (? . 0) q panel:horizontal-dragable%)) q (108502 . 4)) ((c meth c (c (? . 4) q get-box-input-editor-snip%)) q (151523 . 3)) ((c meth c (c (? . 14) q remove-sexp)) q (121714 . 3)) ((c def c (? . 86)) q (133837 . 4)) ((c def c (c (? . 0) q version:version)) q (163616 . 2)) ((c def c (c (? . 0) q handler:find-named-format-handler)) q (78610 . 4)) ((c def c (c (? . 22) q gui-utils:delay-action)) q (75504 . 7)) ((c def c (c (? . 0) q color-prefs:add-to-preferences-panel)) q (4772 . 5)) ((c meth c (c (? . 2) q on-new-tab-snip)) q (92333 . 5)) ((c meth c (c (? . 3) q edit-menu:get-find-case-sensitive-item)) q (54142 . 3)) ((c def c (c (? . 0) q handler:set-recent-items-frame-superclass)) q (79574 . 3)) ((c meth c (c (? . 15) q unhighlight-range)) q (127257 . 12)) ((c meth c (c (? . 14) q select-backward-sexp)) q (122892 . 2)) ((c meth c (c (? . 1) q can-delete?)) q (102457 . 5)) ((c form c (c (? . 0) q scheme:text-mode%)) q (163781 . 2)) ((c def c (? . 45)) q (137978 . 3)) ((c def c (c (? . 0) q racket:get-color-prefs-table)) q (125263 . 3)) ((c def c (? . 78)) q (155267 . 2)) ((c def c (c (? . 0) q editor:set-standard-style-list-pref-callbacks)) q (21885 . 2)) ((c def c (c (? . 0) q panel:dragable-place-children)) q (110682 . 19)) ((c def c (c (? . 0) q color:get-parenthesis-colors-table)) q (12121 . 3)) ((c meth c (c (? . 87) q map-function)) q (81458 . 5)) ((c meth c (c (? . 3) q edit-menu:find-from-selection-on-demand)) q (49744 . 4)) ((c meth c (c (? . 4) q insert-before)) q (150262 . 3)) ((c def c (? . 1)) q (98447 . 3)) ((c meth c (c (? . 1) q can-load-file?)) q (103091 . 5)) ((c def c (c (? . 0) q frame:current-icon)) q (71475 . 10)) ((c meth c (c (? . 4) q get-in-box-port)) q (151220 . 2)) ((c meth c (c (? . 2) q on-local-event)) q (88356 . 7)) ((c meth c (c (? . 88) q ask-normalize?)) q (134759 . 2)) ((c meth c (c (? . 4) q get-in-port)) q (151162 . 2)) ((c meth c (c (? . 5) q help-menu:create-about?)) q (63453 . 2)) ((c def c (c (? . 28) q get-splash-event-callback)) q (159959 . 2)) ((c meth c (c (? . 6) q get-editor%)) q (69143 . 3)) ((c meth c (c (? . 2) q on-focus)) q (87464 . 7)) ((c def c (c (? . 0) q finder:dialog-parent-parameter)) q (22690 . 5)) ((c def c (c (? . 0) q editor:standard-style-list<%>)) q (18558 . 3)) ((c def c (c (? . 26) q test:new-window)) q (162501 . 3)) ((c meth c (c (? . 89) q on-disable-surrogate)) q (85633 . 2)) ((c meth c (c (? . 3) q edit-menu:create-clear?)) q (46890 . 3)) ((c def c (c (? . 0) q preferences:add-on-close-dialog-callback)) q (114354 . 3)) ((c def c (c (? . 0) q racket:text%)) q (124677 . 4)) ((c def c (? . 52)) q (33924 . 3)) ((c def c (? . 64)) q (19329 . 3)) ((c def c (c (? . 26) q test:reraise-error)) q (162849 . 2)) ((c meth c (c (? . 3) q file-menu:create-quit?)) q (42221 . 3)) ((c meth c (c (? . 14) q up-sexp)) q (122438 . 3)) ((c meth c (c (? . 17) q get-corner-bitmap)) q (13132 . 3)) ((c def c (c (? . 0) q keymap:get-global)) q (83106 . 2)) ((c def c (c (? . 0) q frame:text-info%)) q (69491 . 3)) ((c def c (c (? . 0) q editor:keymap-mixin)) q (18960 . 4)) ((c constructor c (? . 41)) q (29828 . 16)) ((c def c (c (? . 0) q frame:pasteboard<%>)) q (63913 . 3)) ((c meth c (c (? . 3) q edit-menu:replace-callback)) q (52731 . 7)) ((c meth c (c (? . 38) q on-new-box)) q (17682 . 3)) ((c form c (c (? . 93) q framework-class^)) q (164307 . 2)) ((c meth c (c (? . 31) q search-hidden?)) q (66004 . 2)) ((c meth c (c (? . 7) q freeze-colorer)) q (7673 . 2)) ((c meth c (c (? . 5) q set-label)) q (61463 . 3)) ((c meth c (c (? . 3) q file-menu:open-on-demand)) q (36826 . 4)) ((c meth c (c (? . 1) q after-set-position)) q (101922 . 2)) ((c meth c (c (? . 15) q get-port-name)) q (129308 . 3)) ((c meth c (c (? . 3) q get-menu-item%)) q (35159 . 3)) ((c def c (c (? . 0) q color-prefs:unmarshall-style-delta)) q (5716 . 4)) ((c def c (c (? . 0) q pasteboard:basic%)) q (111543 . 3)) ((c def c (c (? . 0) q text:crlf-line-endings<%>)) q (148305 . 3)) ((c meth c (c (? . 3) q edit-menu:redo-string)) q (44112 . 2)) ((c meth c (c (? . 3) q edit-menu:redo-help-string)) q (44186 . 3)) ((c meth c (c (? . 85) q put-file)) q (130845 . 5)) ((c meth c (c (? . 10) q edit-menu:find-case-sensitive-callback)) q (68210 . 3)) ((c def c (c (? . 0) q racket:setup-keymap)) q (125807 . 3)) ((c def c (c (? . 0) q preferences:add-to-general-checkbox-panel)) q (114082 . 3)) ((c meth c (c (? . 14) q flash-forward-sexp)) q (121893 . 3)) ((c meth c (c (? . 12) q for-each-frame)) q (72469 . 3)) ((c def c (c (? . 0) q text:return<%>)) q (137567 . 3)) ((c meth c (c (? . 31) q search-hits-changed)) q (66868 . 2)) ((c def c (? . 76)) q (105706 . 4)) ((c def c (c (? . 0) q keymap:canonicalize-keybinding-string)) q (82831 . 4)) ((c def c (? . 97)) q (108141 . 4)) ((c meth c (c (? . 3) q file-menu:get-revert-item)) q (37947 . 3)) ((c meth c (c (? . 10) q edit-menu:create-find-case-sensitive?)) q (68416 . 3)) ((c meth c (c (? . 90) q on-display-size)) q (152180 . 2)) ((c meth c (c (? . 56) q on-superwindow-show)) q (28920 . 3)) ((c meth c (c (? . 77) q make-snip)) q (14662 . 4)) ((c meth c (c (? . 3) q edit-menu:paste-on-demand)) q (46381 . 4)) ((c def c (c (? . 0) q handler:current-create-new-window)) q (79135 . 5)) ((c meth c (c (? . 3) q get-file-menu)) q (35377 . 2)) ((c def c (c (? . 0) q color-prefs:marshall-style-delta)) q (5597 . 3)) ((c meth c (c (? . 17) q get-position)) q (13421 . 3)) ((c meth c (c (? . 11) q get-area-container)) q (27848 . 3)) ((c meth c (c (? . 12) q insert-frame)) q (72745 . 3)) ((c meth c (c (? . 91) q get-editor<%>)) q (64282 . 2)) ((c meth c (c (? . 36) q get-search-bubbles)) q (136518 . 6)) ((c meth c (c (? . 92) q restore-keybinding)) q (84543 . 2)) ((c form c (c (? . 0) q scheme:text-mode-mixin)) q (163751 . 2)) ((c def c (? . 36)) q (135672 . 4)) ((c meth c (c (? . 30) q get-corner-bitmap)) q (12570 . 3)) ((c meth c (c (? . 2) q after-edit-sequence)) q (94283 . 6)) ((c meth c (c (? . 7) q on-lexer-valid)) q (10362 . 3)) ((c meth c (c (? . 37) q update-info)) q (32914 . 2)) ((c def c (? . 70)) q (20572 . 5)) ((c meth c (c (? . 1) q on-default-char)) q (98672 . 3)) ((c meth c (c (? . 3) q edit-menu:find-previous-callback)) q (51055 . 7)) ((c def c (c (? . 0) q panel:dragable-container-size)) q (110362 . 7)) ((c def c (c (? . 0) q color:text-mode%)) q (12025 . 3)) ((c meth c (c (? . 78) q set-line-numbers-color)) q (155476 . 3)) ((c meth c (c (? . 39) q split)) q (138722 . 7)) ((c meth c (c (? . 79) q after-insert)) q (134479 . 5)) ((c form c (c (? . 0) q scheme:get-color-prefs-table)) q (164085 . 2)) ((c form c (c (? . 93) q framework^)) q (164272 . 2)) ((c meth c (c (? . 2) q on-save-file)) q (90354 . 9)) ((c meth c (c (? . 4) q get-value-port)) q (151402 . 2)) ((c meth c (c (? . 10) q on-close)) q (68599 . 2)) ((c def c (c (? . 0) q frame:reorder-menus)) q (71306 . 3)) ((c def c (c (? . 0) q keymap:send-map-function-meta)) q (83303 . 7)) ((c meth c (c (? . 4) q send-eof-to-in-port)) q (150515 . 2)) ((c meth c (c (? . 1) q on-change-style)) q (100908 . 5)) ((c meth c (c (? . 3) q edit-menu:select-all-help-string)) q (48289 . 3)) ((c meth c (c (? . 3) q help-menu:about-on-demand)) q (56614 . 4)) ((c meth c (c (? . 12) q locate-file)) q (73085 . 4)) ((c meth c (c (? . 3) q file-menu:new-on-demand)) q (36011 . 4)) ((c def c (c (? . 0) q frame:text<%>)) q (63522 . 3)) ((c def c (c (? . 48) q preferences:get)) q (114988 . 3)) ((c meth c (c (? . 3) q file-menu:print-string)) q (41004 . 2)) ((c def c (c (? . 0) q preferences:show-dialog)) q (114260 . 2)) ((c def c (? . 94)) q (124182 . 5)) ((c def c (? . 37)) q (32522 . 3)) ((c constructor c (? . 91)) q (64141 . 4)) ((c meth c (c (? . 31) q search-replace)) q (65675 . 2)) ((c meth c (c (? . 72) q on-enable-surrogate)) q (11960 . 2)) ((c meth c (c (? . 68) q on-local-char)) q (137880 . 3)) ((c meth c (c (? . 20) q after-insert)) q (146226 . 5)) ((c def c (? . 55)) q (19767 . 4)) ((c def c (c (? . 0) q frame:searchable-text<%>)) q (68654 . 4)) ((c meth c (c (? . 5) q file-menu:print-callback)) q (62652 . 5)) ((c def c (c (? . 26) q test:mouse-click)) q (161883 . 8)) ((c meth c (c (? . 3) q edit-menu:select-all-string)) q (48208 . 3)) ((c meth c (c (? . 5) q file-menu:create-save-as?)) q (62581 . 2)) ((c def c (c (? . 0) q text:delegate%)) q (154108 . 3)) ((c meth c (c (? . 37) q get-info-canvas)) q (33082 . 3)) ((c def c (c (? . 0) q color-prefs:white-on-black)) q (5877 . 2)) ((c meth c (c (? . 8) q has-focus?)) q (15047 . 2)) ((c meth c (c (? . 3) q file-menu:quit-string)) q (42654 . 2)) ((c meth c (c (? . 8) q local-edit-sequence?)) q (15104 . 2)) ((c meth c (c (? . 58) q set-orientation)) q (109531 . 4)) ((c def c (? . 69)) q (133378 . 5)) ((c meth c (c (? . 64) q allow-close-with-no-filename?)) q (19578 . 2)) ((c def c (c (? . 22) q gui-utils:ok/cancel-buttons)) q (74370 . 14)) ((c def c (c (? . 0) q racket:init-wordbreak-map)) q (125722 . 3)) ((c meth c (c (? . 13) q on-close)) q (31553 . 2)) ((c meth c (c (? . 1) q on-new-tab-snip)) q (101331 . 2)) ((c meth c (c (? . 7) q set-spell-current-dict)) q (8347 . 3)) ((c def c (c (? . 0) q panel:single-pane%)) q (105626 . 3)) ((c def c (c (? . 0) q keymap:add-to-right-button-menu/before)) q (82447 . 5)) ((c meth c (c (? . 3) q edit-menu:between-cut-and-copy)) q (45054 . 4)) ((c meth c (c (? . 3) q file-menu:quit-callback)) q (42298 . 6)) ((c meth c (c (? . 3) q file-menu:save-as-on-demand)) q (40039 . 4)) ((c meth c (c (? . 4) q send-eof-to-box-in-port)) q (150575 . 2)) ((c def c (c (? . 0) q handler:handler?)) q (77852 . 3)) ((c def c (c (? . 0) q version:add-spec)) q (163518 . 4)) ((c def c (c (? . 0) q handler:edit-file)) q (78856 . 6)) ((c meth c (c (? . 13) q on-activate)) q (31612 . 3)) ((c meth c (c (? . 7) q set-spell-check-strings)) q (8259 . 3)) ((c meth c (c (? . 24) q after-set-position)) q (147489 . 2)) ((c meth c (c (? . 3) q edit-menu:create-replace?)) q (52651 . 3)) ((c meth c (c (? . 3) q edit-menu:find-from-selection-callback)) q (49405 . 7)) ((c form c (c (? . 0) q scheme:text-mode<%>)) q (163724 . 2)) ((c def c (? . 88)) q (134679 . 3)) ((c meth c (c (? . 23) q get-label-prefix)) q (57370 . 2)) ((c def c (c (? . 0) q racket:add-coloring-preferences-panel)) q (125204 . 2)) ((c meth c (c (? . 3) q edit-menu:create-find-next?)) q (50174 . 3)) ((c meth c (c (? . 1) q on-new-box)) q (99443 . 3)) ((c meth c (c (? . 40) q on-subwindow-event)) q (107171 . 5)) ((c meth c (c (? . 5) q get-label)) q (61409 . 2)) ((c meth c (c (? . 20) q on-edit-sequence)) q (145926 . 2)) ((c def c (c (? . 0) q icon:get-left/right-cursor)) q (80449 . 2)) ((c meth c (c (? . 8) q save-file/gui-error)) q (15545 . 9)) ((c meth c (c (? . 20) q unhighlight-range)) q (144612 . 12)) ((c meth c (c (? . 32) q get-editor%)) q (65406 . 3)) ((c meth c (c (? . 70) q set-modified)) q (21159 . 3)) ((c def c (c (? . 0) q frame:pasteboard-info-mixin)) q (34760 . 4)) ((c meth c (c (? . 54) q highlight-first-line)) q (131332 . 3)) ((c def c (c (? . 0) q keymap:aug-keymap%)) q (81650 . 3)) ((c meth c (c (? . 3) q edit-menu:find-case-sensitive-help-string)) q (54918 . 3)) ((c meth c (c (? . 31) q get-text-to-search)) q (65797 . 2)) ((c def c (c (? . 0) q text:info%)) q (155168 . 3)) ((c meth c (c (? . 15) q get-fixed-style)) q (128447 . 2)) ((c meth c (c (? . 103) q on-size)) q (2019 . 5)) ((c meth c (c (? . 3) q edit-menu:between-find-and-preferences)) q (55013 . 4)) ((c def c (c (? . 28) q get-splash-eventspace)) q (158988 . 2)) ((c meth c (c (? . 15) q highlight-range)) q (125985 . 22)) ((c meth c (c (? . 23) q get-canvas%)) q (57521 . 3)) ((c def c (? . 30)) q (12320 . 4)) ((c def c (? . 23)) q (57228 . 3)) ((c meth c (c (? . 95) q on-close)) q (29460 . 2)) ((c meth c (c (? . 4) q set-allow-edits)) q (149997 . 3)) ((c meth c (c (? . 76) q get-vertical?)) q (106539 . 2)) ((c def c (c (? . 26) q test:get-active-top-level-window)) q (163117 . 3)) ((c def c (c (? . 0) q racket:text-mode<%>)) q (124137 . 2)) ((c def c (c (? . 22) q gui-utils:quote-literal-label)) q (73772 . 7)) ((c constructor c (? . 96)) q (63732 . 4)) ((c meth c (c (? . 97) q get-vertical?)) q (108309 . 2)) ((c meth c (c (? . 2) q after-set-position)) q (93802 . 6)) ((c meth c (c (? . 14) q backward-sexp)) q (122219 . 3)) ((c meth c (c (? . 59) q set-line-numbers-color)) q (155936 . 3)) ((c meth c (c (? . 89) q on-enable-surrogate)) q (85566 . 2)) ((c meth c (c (? . 3) q edit-menu:create-show/hide-replace?)) q (51796 . 3)) ((c meth c (c (? . 1) q after-load-file)) q (102113 . 3)) ((c def c (? . 98)) q (21333 . 4)) ((c def c (? . 31)) q (65485 . 3)) ((c meth c (c (? . 3) q get-help-menu)) q (35527 . 2)) ((c meth c (c (? . 95) q show)) q (29382 . 3)) ((c meth c (c (? . 52) q anchor-status-changed)) q (34160 . 2)) ((c meth c (c (? . 3) q file-menu:between-print-and-close)) q (41160 . 4)) ((c def c (c (? . 0) q text:normalize-paste%)) q (154004 . 3)) ((c meth c (c (? . 3) q edit-menu:paste-string)) q (46499 . 2)) ((c meth c (c (? . 38) q put-file)) q (18350 . 5)) ((c def c (? . 72)) q (11205 . 4)) ((c def c (c (? . 0) q color-prefs:set-default/color-scheme)) q (3645 . 8)) ((c meth c (c (? . 3) q file-menu:close-on-demand)) q (41704 . 4)) ((c meth c (c (? . 31) q get-case-sensitive-search?)) q (66791 . 3)) ((c def c (c (? . 0) q text:range-color)) q (156459 . 3)) ((c meth c (c (? . 14) q move-sexp-out)) q (123530 . 3)) ((c meth c (c (? . 10) q edit-menu:replace-all-on-demand)) q (68021 . 4)) ((c def c (c (? . 0) q finder:common-get-file-list)) q (27113 . 13)) ((c meth c (c (? . 1) q after-change-style)) q (101454 . 5)) ((c def c (c (? . 0) q racket:get-keymap)) q (125150 . 2)) ((c def c (c (? . 26) q test:set-choice!)) q (161133 . 4)) ((c meth c (c (? . 10) q edit-menu:replace-all-callback)) q (67940 . 3)) ((c meth c (c (? . 99) q container-size)) q (105222 . 7)) ((c meth c (c (? . 5) q file-menu:create-revert?)) q (62027 . 2)) ((c def c (c (? . 26) q test:close-top-level-window)) q (162584 . 3)) ((c meth c (c (? . 65) q get-position)) q (14028 . 3)) ((c meth c (c (? . 54) q is-special-first-line?)) q (131580 . 3)) ((c def c (c (? . 0) q panel:single%)) q (105522 . 3)) ((c meth c (c (? . 12) q set-active-frame)) q (72645 . 3)) ((c meth c (c (? . 96) q get-editor<%>)) q (63855 . 2)) ((c meth c (c (? . 23) q revert)) q (57885 . 2)) ((c meth c (c (? . 4) q get-err-style-delta)) q (150968 . 3)) ((c def c (c (? . 48) q exn:struct:unknown-preference)) q (116824 . 2)) ((c meth c (c (? . 30) q make-editor)) q (12426 . 2)) ((c def c (c (? . 0) q frame:remove-empty-menus)) q (71388 . 3)) ((c def c (c (? . 28) q set-splash-event-callback)) q (159859 . 3)) ((c def c (c (? . 0) q handler:find-format-handler)) q (78733 . 4)) ((c meth c (c (? . 3) q edit-menu:between-select-all-and-find)) q (48375 . 4)) ((c meth c (c (? . 81) q get-read-write?)) q (148732 . 2)) ((c meth c (c (? . 3) q help-menu:before-about)) q (56081 . 4)) ((c meth c (c (? . 61) q show-delegated-text)) q (64803 . 2)) ((c meth c (c (? . 2) q on-default-char)) q (86243 . 7)) ((c meth c (c (? . 85) q on-insert)) q (130558 . 4)) ((c meth c (c (? . 8) q get-pos/text)) q (16575 . 5)) ((c meth c (c (? . 87) q remove-chained-keymap)) q (81349 . 3)) ((c meth c (c (? . 1) q on-event)) q (98960 . 3)) ((c def c (c (? . 0) q finder:default-filters)) q (23041 . 4)) ((c def c (? . 59)) q (155575 . 4)) ((c def c (c (? . 0) q racket:set-mode-mixin)) q (124523 . 4)) ((c def c (c (? . 48) q preferences:set-un/marshall)) q (116004 . 7)) ((c meth c (c (? . 43) q on-close)) q (33875 . 2)) ((c meth c (c (? . 90) q can-insert?)) q (151837 . 4)) ((c meth c (c (? . 3) q edit-menu:replace-help-string)) q (53242 . 3)) ((c meth c (c (? . 90) q on-local-char)) q (152083 . 3)) ((c meth c (c (? . 2) q on-change-style)) q (91087 . 9)) ((c def c (c (? . 0) q icon:get-gc-off-bitmap)) q (80630 . 2)) ((c meth c (c (? . 3) q file-menu:revert-on-demand)) q (38436 . 4)) ((c meth c (c (? . 80) q container-size)) q (104700 . 3)) ((c def c (c (? . 0) q color:misspelled-text-color-style-name)) q (12263 . 2)) ((c meth c (c (? . 4) q clear-output-ports)) q (150695 . 2)) ((c form c (c (? . 0) q scheme:add-coloring-preferences-panel)) q (164040 . 2)) ((c meth c (c (? . 3) q file-menu:new-callback)) q (35784 . 6)) ((c meth c (c (? . 5) q file-menu:open-callback)) q (61544 . 5)) ((c def c (? . 67)) q (34422 . 4)) ((c def c (? . 87)) q (81015 . 4)) ((c meth c (c (? . 14) q transpose-sexp)) q (123068 . 3)) ((c meth c (c (? . 3) q edit-menu:find-previous-string)) q (51502 . 3)) ((c meth c (c (? . 71) q restore-underscores)) q (84936 . 3)) ((c meth c (c (? . 14) q select-forward-sexp)) q (122831 . 2)) ((c meth c (c (? . 51) q recalc-snips)) q (1618 . 2)) ((c meth c (c (? . 2) q can-change-style?)) q (95052 . 9)) ((c meth c (c (? . 23) q get-canvas)) q (58255 . 2)) ((c meth c (c (? . 74) q set-surrogate)) q (98309 . 3)) ((c def c (? . 57)) q (31700 . 3)) ((c meth c (c (? . 30) q make-snip)) q (12495 . 2)) ((c meth c (c (? . 8) q get-pos/text-dc-location)) q (16738 . 7)) ((c meth c (c (? . 3) q edit-menu:get-undo-item)) q (42920 . 3)) ((c def c (c (? . 0) q editor:standard-style-list-mixin)) q (18640 . 4)) ((c meth c (c (? . 5) q file-menu:save-as-callback)) q (62370 . 5)) ((c meth c (c (? . 21) q draw)) q (118291 . 21)) ((c meth c (c (? . 31) q unhide-search-and-toggle-focus)) q (66581 . 4)) ((c meth c (c (? . 70) q on-change)) q (21096 . 2)) ((c meth c (c (? . 3) q file-menu:open-callback)) q (36597 . 6)) ((c meth c (c (? . 3) q file-menu:get-open-recent-item)) q (37107 . 3)) ((c def c (c (? . 0) q editor:autowrap-mixin)) q (19181 . 4)) ((c meth c (c (? . 3) q file-menu:quit-on-demand)) q (42527 . 4)) ((c def c (c (? . 0) q panel:vertical-dragable%)) q (108381 . 4)) ((c meth c (c (? . 3) q file-menu:between-new-and-open)) q (36289 . 4)) ((c meth c (c (? . 39) q insert)) q (140251 . 7)) ((c meth c (c (? . 76) q set-orientation)) q (106600 . 3)) ((c def c (c (? . 26) q test:use-focus-table)) q (162952 . 4)) ((c def c (c (? . 28) q get-splash-paint-callback)) q (159039 . 7)) ((c meth c (c (? . 19) q get-extent)) q (141838 . 22)) ((c def c (c (? . 28) q set-splash-bitmap)) q (158857 . 3)) ((c def c (? . 19)) q (141401 . 3)) ((c def c (c (? . 48) q preferences:restore-defaults)) q (116288 . 2)) ((c def c (c (? . 0) q color:text%)) q (11083 . 3)) ((c def c (c (? . 22) q gui-utils:next-untitled-name)) q (75189 . 2)) ((c meth c (c (? . 37) q hide-info)) q (33383 . 2)) ((c meth c (c (? . 2) q on-set-size-constraint)) q (92530 . 6)) ((c def c (c (? . 0) q editor:add-after-user-keymap)) q (22023 . 6)) ((c def c (c (? . 0) q text:range-style)) q (156365 . 3)) ((c meth c (c (? . 3) q edit-menu:select-all-callback)) q (47789 . 7)) ((c def c (c (? . 0) q finder:get-file)) q (26573 . 12)) ((c meth c (c (? . 25) q after-load-file)) q (149405 . 2)) ((c meth c (c (? . 59) q show-line-numbers?)) q (155867 . 2)) ((c def c (c (? . 0) q racket:add-preferences-panel)) q (125098 . 2)) ((c meth c (c (? . 3) q edit-menu:copy-on-demand)) q (45579 . 4)) ((c meth c (c (? . 4) q do-submission)) q (149617 . 2)) ((c meth c (c (? . 7) q get-spell-check-strings)) q (8192 . 2)) ((c def c (c (? . 48) q preferences:unregister-save-callback)) q (116447 . 3)) ((c def c (c (? . 22) q gui-utils:cursor-delay)) q (75243 . 4)) ((c def c (? . 99)) q (105024 . 5)) ((c def c (c (? . 0) q keymap:add-to-right-button-menu)) q (82000 . 10)) ((c def c (c (? . 0) q panel:horizontal-dragable<%>)) q (106789 . 3)) ((c meth c (c (? . 20) q on-paint)) q (145192 . 19)) ((c meth c (c (? . 52) q editor-position-changed)) q (34227 . 2)) ((c def c (c (? . 0) q frame:add-snip-menu-items)) q (71013 . 7)) ((c meth c (c (? . 3) q edit-menu:get-find-next-item)) q (50061 . 3)) ((c meth c (c (? . 2) q can-load-file?)) q (97066 . 9)) ((c def c (? . 100)) q (104223 . 3)) ((c meth c (c (? . 37) q set-info-canvas)) q (32966 . 3)) ((c meth c (c (? . 23) q get-editor%)) q (57675 . 3)) ((c meth c (c (? . 15) q get-highlighted-ranges)) q (128307 . 3)) ((c meth c (c (? . 2) q on-default-event)) q (86524 . 7)) ((c meth c (c (? . 101) q make-editor)) q (14417 . 3)) ((c meth c (c (? . 3) q file-menu:save-help-string)) q (39465 . 3)) ((c def c (c (? . 28) q start-splash)) q (157106 . 24)) ((c meth c (c (? . 12) q get-active-frame)) q (72572 . 2)) ((c form c (c (? . 0) q scheme:text<%>)) q (163657 . 2)) ((c def c (c (? . 0) q finder:std-put-file)) q (24552 . 17)) ((c def c (? . 5)) q (58389 . 4)) ((c meth c (c (? . 76) q get-percentages)) q (106467 . 2)) ((c meth c (c (? . 18) q after-delete)) q (11030 . 2)) ((c meth c (c (? . 8) q can-close?)) q (16394 . 2)) ((c def c (? . 90)) q (151697 . 4)) ((c meth c (c (? . 11) q get-area-container%)) q (27753 . 3)) ((c form c (c (? . 0) q scheme:get-white-on-black-color-prefs-table)) q (164121 . 2)) ((c def c (c (? . 0) q icon:get-gc-on-bitmap)) q (80572 . 2)) ((c meth c (c (? . 75) q get-word-at)) q (123916 . 3)) ((c def c (c (? . 0) q color-prefs:register-color-preference)) q (4011 . 13)) ((c meth c (c (? . 3) q edit-menu:get-preferences-item)) q (55144 . 3)) ((c def c (c (? . 0) q group:on-close-action)) q (73258 . 2)) ((c meth c (c (? . 3) q edit-menu:show/hide-replace-callback)) q (51886 . 7)) ((c meth c (c (? . 23) q set-label-prefix)) q (57431 . 3)) ((c meth c (c (? . 20) q after-load-file)) q (146988 . 3)) ((c def c (? . 56)) q (28614 . 4)) ((c meth c (c (? . 1) q on-new-image-snip)) q (99521 . 9)) ((c meth c (c (? . 14) q get-forward-sexp)) q (121598 . 4)) ((c def c (? . 47)) q (80689 . 3)) ((c meth c (c (? . 3) q edit-menu:after-preferences)) q (55961 . 4)) ((c meth c (c (? . 3) q file-menu:open-recent-string)) q (37652 . 3)) ((c meth c (c (? . 3) q file-menu:get-close-item)) q (41286 . 3)) ((c meth c (c (? . 47) q get-chained-keymaps)) q (80760 . 3)) ((c meth c (c (? . 4) q set-unread-start-point)) q (149902 . 3)) ((c meth c (c (? . 14) q flash-backward-sexp)) q (122114 . 3)) ((c meth c (c (? . 3) q edit-menu:get-replace-all-item)) q (53325 . 3)) ((c meth c (c (? . 85) q on-paint)) q (129855 . 19)) ((c meth c (c (? . 3) q get-menu%)) q (35059 . 3)) ((c meth c (c (? . 3) q edit-menu:get-show/hide-replace-item)) q (51675 . 3)) ((c meth c (c (? . 2) q after-load-file)) q (94484 . 7)) ((c def c (? . 3)) q (34919 . 3)) ((c meth c (c (? . 8) q save-file-out-of-date?)) q (15476 . 2)) ((c meth c (c (? . 3) q get-edit-menu)) q (35452 . 2)) ((c meth c (c (? . 18) q after-change-style)) q (10855 . 2)) ((c meth c (c (? . 3) q edit-menu:cut-help-string)) q (44975 . 3)) ((c meth c (c (? . 46) q auto-complete)) q (152610 . 2)) ((c meth c (c (? . 38) q get-file)) q (18238 . 3)) ((c meth c (c (? . 7) q is-lexer-valid?)) q (10447 . 2)) ((c meth c (c (? . 4) q get-insertion-point)) q (149671 . 2)) ((c def c (c (? . 22) q gui-utils:local-busy-cursor)) q (75735 . 7)) ((c meth c (c (? . 46) q get-autocomplete-background-color)) q (152778 . 3)) ((c meth c (c (? . 3) q edit-menu:redo-on-demand)) q (43995 . 4)) ((c def c (? . 102)) q (107905 . 4)) ((c def c (c (? . 0) q text:range-start)) q (156096 . 3)) ((c meth c (c (? . 3) q edit-menu:find-from-selection-string)) q (49876 . 3)) ((c meth c (c (? . 94) q on-disable-surrogate)) q (124390 . 2)) ((c def c (c (? . 28) q set-splash-progress-bar?!)) q (159690 . 3)) ((c def c (? . 39)) q (138649 . 3)) ((c meth c (c (? . 101) q make-snip)) q (14326 . 3)) ((c def c (c (? . 0) q color:text-mode<%>)) q (11161 . 2)) ((c meth c (c (? . 76) q after-percentage-change)) q (105809 . 2)) ((c meth c (c (? . 55) q can-close?)) q (20077 . 2)) ((c def c (c (? . 0) q editor:set-default-font-color)) q (21550 . 3)) ((c meth c (c (? . 54) q get-first-line-height)) q (131511 . 2)) ((c meth c (c (? . 101) q copy)) q (14497 . 3)) ((c meth c (c (? . 41) q on-move)) q (31086 . 5)) ((c def c (c (? . 48) q preferences:low-level-get-preference)) q (117125 . 5)) ((c def c (c (? . 0) q finder:put-file)) q (25852 . 17)) ((c meth c (c (? . 34) q do-autosave)) q (20426 . 2)) ((c meth c (c (? . 7) q classify-position)) q (10048 . 4)) ((c meth c (c (? . 7) q get-token-range)) q (10175 . 5)) ((c meth c (c (? . 15) q get-start-of-line)) q (129555 . 4)) ((c meth c (c (? . 61) q hide-delegated-text)) q (64739 . 2)) ((c meth c (c (? . 1) q can-save-file?)) q (103259 . 5)) ((c constructor c (? . 101)) q (14221 . 3)) ((c meth c (c (? . 2) q on-insert)) q (91793 . 9)) ((c meth c (c (? . 3) q file-menu:save-callback)) q (39035 . 6)) ((c meth c (c (? . 18) q on-focus)) q (10687 . 2)) ((c meth c (c (? . 3) q edit-menu:between-copy-and-paste)) q (45850 . 4)) ((c meth c (c (? . 3) q file-menu:close-help-string)) q (41907 . 3)) ((c meth c (c (? . 3) q file-menu:create-new?)) q (35709 . 2)) ((c meth c (c (? . 3) q on-close)) q (35000 . 2)) ((c def c (c (? . 0) q frame:setup-size-pref)) q (70353 . 13)) ((c meth c (c (? . 1) q after-insert)) q (101770 . 5)) ((c def c (? . 103)) q (1869 . 4)) ((c meth c (c (? . 3) q edit-menu:find-previous-help-string)) q (51586 . 3)) ((c meth c (c (? . 32) q make-root-area-container)) q (65123 . 6)) ((c def c (c (? . 0) q text:get-completions/manuals)) q (156865 . 3)) ((c meth c (c (? . 4) q reset-input-box)) q (150639 . 2)) ((c def c (c (? . 0) q finder:common-get-file)) q (23986 . 12)) ((c def c (? . 104)) q (57012 . 4)) ((c def c (? . 21)) q (117716 . 5)) ((c def c (c (? . 0) q icon:get-lock-bitmap)) q (80274 . 2)) ((c meth c (c (? . 3) q help-menu:create-about?)) q (56305 . 3)) ((c meth c (c (? . 29) q on-paint)) q (131816 . 19))))
parameter
