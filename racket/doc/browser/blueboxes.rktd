5108
((3) 0 () 13 ((q lib "browser/browser.rkt") (c (? . 0) q hyper-text-mixin) (c (? . 0) q hyper-canvas-mixin) (c (? . 0) q hyper-panel-mixin) (q lib "browser/external.rkt") (c (? . 10) q html-text<%>) (q 7582 . 3) (c (? . 0) q image-map-snip%) (q 7677 . 4) (c (? . 0) q hyper-frame-mixin) (q lib "browser/htmltext.rkt") (c (? . 0) q hyper-frame<%>) (c (? . 0) q hyper-text<%>)) () (h ! (equal) ((c meth c (c (? . 3) q get-canvas)) q (6232 . 2)) ((c def c (c (? . 0) q make-exn:cancelled)) c (? . 6)) ((c meth c (c (? . 1) q post-url)) q (3043 . 5)) ((c meth c (c (? . 1) q find-tag)) q (2800 . 4)) ((c def c (? . 2)) q (4492 . 3)) ((c meth c (c (? . 2) q set-page)) q (5249 . 4)) ((c meth c (c (? . 1) q hyper-delta)) q (2622 . 2)) ((c meth c (c (? . 11) q get-hyper-panel)) q (390 . 2)) ((c def c (c (? . 4) q browser-preference?)) q (9861 . 3)) ((c meth c (c (? . 7) q get-key)) q (7288 . 2)) ((c meth c (c (? . 5) q make-link-style)) q (8390 . 5)) ((c def c (c (? . 0) q exn:file-saved-instead-pathname)) c (? . 8)) ((c meth c (c (? . 3) q make-control-bar-panel)) q (6013 . 3)) ((c meth c (c (? . 3) q make-canvas)) q (5824 . 3)) ((c def c (c (? . 0) q hyper-text%)) q (4414 . 3)) ((c def c (c (? . 0) q page->editor)) q (6827 . 3)) ((c def c (c (? . 4) q update-browser-preference)) q (9926 . 3)) ((c meth c (c (? . 3) q leaving-page)) q (6357 . 5)) ((c meth c (c (? . 5) q add-thunk-callback)) q (8886 . 7)) ((c def c (c (? . 0) q hyper-no-show-frame-mixin)) q (952 . 3)) ((c meth c (c (? . 3) q rewind)) q (6135 . 2)) ((q form ((lib "browser/browser-sig.rkt") browser^)) q (7853 . 2)) ((c meth c (c (? . 2) q get-editor%)) q (4690 . 2)) ((q def ((lib "browser/tool.rkt") tool@)) q (10180 . 2)) ((c meth c (c (? . 3) q forward)) q (6183 . 2)) ((c meth c (c (? . 3) q get-canvas%)) q (5935 . 3)) ((c def c (c (? . 0) q exn:cancelled)) c (? . 6)) ((c meth c (c (? . 5) q post-url)) q (9165 . 5)) ((c def c (c (? . 0) q struct:exn:cancelled)) c (? . 6)) ((c def c (c (? . 0) q exn:cancelled?)) c (? . 6)) ((c def c (c (? . 4) q send-url)) q (9751 . 4)) ((c def c (c (? . 0) q html-eval-ok)) q (188 . 4)) ((c meth c (c (? . 1) q make-link-style)) q (2214 . 5)) ((c meth c (c (? . 1) q get-title)) q (2495 . 2)) ((c meth c (c (? . 7) q add-area)) q (7343 . 7)) ((c def c (? . 3)) q (5453 . 4)) ((c constructor c (? . 9)) q (590 . 6)) ((c constructor c (? . 3)) q (5595 . 6)) ((c meth c (c (? . 1) q remap-url)) q (4156 . 3)) ((c meth c (c (? . 3) q filter-notes)) q (6515 . 3)) ((c meth c (c (? . 5) q add-racket-callback)) q (8582 . 7)) ((c def c (c (? . 0) q make-exn:file-saved-instead)) c (? . 8)) ((c meth c (c (? . 1) q eval-racket-string)) q (4027 . 3)) ((c meth c (c (? . 1) q add-racket-callback)) q (3438 . 7)) ((c meth c (c (? . 5) q add-link)) q (8093 . 5)) ((c def c (c (? . 0) q editor->page)) q (6751 . 3)) ((c meth c (c (? . 5) q get-url)) q (7947 . 2)) ((c meth c (c (? . 1) q set-title)) q (2547 . 3)) ((c def c (c (? . 0) q open-url)) q (0 . 3)) ((c def c (? . 9)) q (459 . 4)) ((c meth c (c (? . 1) q reload)) q (4109 . 2)) ((c def c (? . 5)) q (7886 . 3)) ((c def c (c (? . 0) q exn:file-saved-instead?)) c (? . 8)) ((c meth c (c (? . 3) q on-navigate)) q (6304 . 2)) ((c def c (c (? . 0) q bullet-size)) q (6899 . 4)) ((c def c (c (? . 0) q exn:file-saved-instead)) c (? . 8)) ((c def c (? . 1)) q (1306 . 4)) ((c meth c (c (? . 2) q goto-url)) q (4814 . 9)) ((c def c (c (? . 10) q html-text-mixin)) q (9378 . 3)) ((c meth c (c (? . 1) q map-shift-style)) q (1918 . 7)) ((q def ((lib "browser/browser-unit.rkt") browser@)) q (7828 . 2)) ((c def c (c (? . 0) q hyper-panel<%>)) q (5413 . 2)) ((c meth c (c (? . 1) q add-link)) q (3258 . 5)) ((c meth c (c (? . 1) q add-thunk-callback)) q (3745 . 7)) ((c constructor c (? . 2)) q (4593 . 3)) ((c meth c (c (? . 7) q set-key)) q (7210 . 3)) ((c meth c (c (? . 2) q current-page)) q (4759 . 2)) ((c def c (c (? . 0) q html-img-ok)) q (102 . 4)) ((c meth c (c (? . 5) q add-tag)) q (8272 . 4)) ((c constructor c (? . 1)) q (1434 . 10)) ((c def c (c (? . 0) q hyper-frame%)) q (1052 . 4)) ((c meth c (c (? . 1) q remove-tag)) q (2965 . 3)) ((c meth c (c (? . 3) q reload)) q (6620 . 2)) ((c def c (c (? . 4) q add-to-browser-prefs-panel)) q (10078 . 3)) ((c meth c (c (? . 1) q add-tag)) q (2681 . 4)) ((c def c (c (? . 0) q struct:exn:file-saved-instead)) c (? . 8)) ((c meth c (c (? . 1) q get-url)) q (2408 . 3)) ((c def c (c (? . 0) q hyper-panel%)) q (6668 . 3)) ((c meth c (c (? . 5) q set-title)) q (8019 . 3)) ((c def c (? . 7)) q (7020 . 3)) ((c def c (? . 12)) q (1166 . 2)) ((c def c (c (? . 0) q hyper-no-show-frame%)) q (838 . 3)) ((c meth c (c (? . 1) q get-hyper-keymap)) q (4261 . 2)) ((c def c (? . 11)) q (276 . 2)) ((c constructor c (? . 7)) q (7076 . 4)) ((c def c (c (? . 0) q hyper-canvas%)) q (4331 . 3)) ((c meth c (c (? . 11) q get-hyper-panel%)) q (316 . 2)) ((c meth c (c (? . 12) q url-allows-evalling?)) q (1205 . 3)) ((c def c (c (? . 4) q install-help-browser-preference-panel)) q (10017 . 2)) ((c def c (c (? . 10) q render-html-to-text)) q (9467 . 9)) ((c meth c (c (? . 2) q after-set-page)) q (5356 . 2))))
procedure
