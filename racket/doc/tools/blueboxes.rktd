34584
((3) 0 () 26 ((q lib "drracket/tool-lib.rkt") (c (? . 8) q syncheck-annotations<%>) (c (? . 0) q drracket:unit:frame<%>) (c (? . 0) q drracket:rep:text%) (c (? . 0) q drracket:unit:frame%) (c (? . 0) q drracket:frame:basics-mixin) (c (? . 0) q drracket:language:language<%>) (c (? . 0) q drracket:rep:context<%>) (q lib "drracket/check-syntax.rkt") (c (? . 0) q drracket:language:module-based-language<%>) (c (? . 0) q drracket:language:simple-module-based-language%) (c (? . 0) q drracket:unit:tab<%>) (c (? . 0) q drracket:language:simple-module-based-language->module-based-language-mixin) (c (? . 0) q drracket:unit:program-editor-mixin) (c (? . 0) q drracket:language:module-based-language->language-mixin) (c (? . 0) q drracket:language:simple-module-based-language<%>) (c (? . 0) q drracket:frame:<%>) (c (? . 0) q drracket:unit:tab%) (c (? . 0) q drracket:unit:definitions-text%) (c (? . 0) q drracket:unit:definitions-text<%>) (c (? . 0) q drracket:unit:interactions-canvas%) (c (? . 0) q drracket:language:module-language<%>) (c (? . 0) q drracket:frame:name-message%) (q lib "lang/htdp-langs-save-file-prefix.rkt") (c (? . 0) q drracket:rep:drs-bindings-keymap-mixin) (q lib "drracket/syncheck-drracket-button.rkt")) () (h ! (equal) ((c def c (c (? . 0) q drscheme:language:get-capability-contract)) q (86842 . 3)) ((c meth c (c (? . 5) q file-menu:between-print-and-close)) q (59716 . 4)) ((c meth c (c (? . 1) q syncheck:add-docs-menu)) q (1914 . 17)) ((c def c (c (? . 0) q drracket:debug:add-prefs-panel)) q (48789 . 2)) ((c meth c (c (? . 9) q default-settings)) q (25299 . 3)) ((c def c (c (? . 0) q drscheme:language:language<%>)) q (69078 . 2)) ((c meth c (c (? . 3) q after-many-evals)) q (54966 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-definitions-canvas)) q (82112 . 5)) ((c meth c (c (? . 1) q syncheck:add-mouse-over-status)) q (4688 . 11)) ((c meth c (c (? . 6) q order-manuals)) q (32448 . 4)) ((c def c (c (? . 0) q drracket:unit:definitions-canvas%)) q (19762 . 3)) ((c meth c (c (? . 12) q use-mred-launcher)) q (24945 . 3)) ((c meth c (c (? . 2) q get-current-tab)) q (15634 . 3)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings)) q (45033 . 7)) ((c constructor c (? . 4)) q (12884 . 3)) ((c def c (c (? . 0) q drracket:rep:after-expression)) q (58447 . 4)) ((c def c (c (? . 0) q drscheme:language:make-simple-settings)) q (93794 . 8)) ((c meth c (c (? . 2) q register-toolbar-buttons)) q (17713 . 7)) ((c meth c (c (? . 3) q highlight-errors)) q (55706 . 6)) ((c meth c (c (? . 4) q on-size)) q (14919 . 2)) ((c def c (? . 1)) q (690 . 2)) ((c def c (c (? . 0) q drracket:language:make-simple-settings)) q (43382 . 14)) ((c def c (c (? . 0) q drscheme:unit:add-to-program-editor-mixin)) q (127878 . 3)) ((c def c (c (? . 0) q drracket:eval:expand-program)) q (62404 . 18)) ((c meth c (c (? . 5) q get-additional-important-urls)) q (60433 . 3)) ((c meth c (c (? . 2) q open-in-new-tab)) q (15916 . 3)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window)) q (52482 . 12)) ((c meth c (c (? . 2) q get-insert-menu)) q (16500 . 2)) ((c def c (c (? . 0) q drracket:language:add-snip-value)) q (34178 . 7)) ((c def c (c (? . 0) q drracket:modes:mode-matches-language)) q (66511 . 4)) ((c meth c (c (? . 3) q get-user-namespace)) q (55534 . 3)) ((c meth c (c (? . 5) q file-menu:open-string)) q (60358 . 2)) ((c meth c (c (? . 6) q config-panel)) q (28869 . 4)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings?)) q (45754 . 4)) ((c meth c (c (? . 7) q clear-annotations)) q (57066 . 2)) ((c meth c (c (? . 4) q change-to-file)) q (13165 . 3)) ((c meth c (c (? . 7) q reset-offer-kill)) q (57674 . 2)) ((c def c (c (? . 8) q make-traversal)) q (0 . 11)) ((c meth c (c (? . 1) q syncheck:add-require-open-menu)) q (1383 . 11)) ((c meth c (c (? . 10) q get-language-position)) q (22934 . 3)) ((c meth c (c (? . 9) q get-module)) q (25872 . 3)) ((c def c (c (? . 0) q drracket:language:text/pos?)) q (40907 . 3)) ((c def c (c (? . 0) q drracket:eval:traverse-program/multiple)) q (63277 . 16)) ((c meth c (c (? . 5) q file-menu:between-open-and-revert)) q (59584 . 4)) ((c def c (c (? . 0) q drracket:eval:get-snip-classes)) q (62322 . 3)) ((c meth c (c (? . 10) q get-language-numbers)) q (22809 . 3)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-online-expansion-handler)) q (96027 . 5)) ((c def c (c (? . 0) q drscheme:help-desk:help-desk)) q (82951 . 5)) ((c def c (c (? . 0) q drracket:get/extend:extend-interactions-canvas)) q (8507 . 8)) ((c meth c (c (? . 10) q get-module)) q (23040 . 3)) ((c def c (c (? . 0) q drracket:language:get-capability-contract)) q (34037 . 3)) ((c form c (c (? . 8) q syncheck:add-rename-menu)) q (6597 . 2)) ((c def c (c (? . 0) q drscheme:language:extend-language-interface)) q (87282 . 4)) ((c def c (? . 13)) q (11989 . 4)) ((c meth c (c (? . 15) q get-language-numbers)) q (20820 . 3)) ((c meth c (c (? . 11) q remove-bkg-running-color)) q (11530 . 3)) ((c def c (c (? . 0) q drracket:unit:open-drscheme-window)) q (20094 . 6)) ((c def c (c (? . 0) q drscheme:modes:mode-repl-submit)) q (95226 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings-language)) q (84406 . 5)) ((c meth c (c (? . 4) q get-editor%)) q (14479 . 2)) ((c def c (c (? . 0) q drscheme:unit:definitions-canvas%)) q (68717 . 2)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window/edition-pairs)) q (71904 . 15)) ((c meth c (c (? . 9) q get-language-numbers)) q (25635 . 3)) ((c def c (c (? . 0) q drracket:debug:make-debug-error-display-handler)) q (48564 . 4)) ((c def c (c (? . 0) q drracket:get/extend:get-interactions-text)) q (7919 . 3)) ((c meth c (c (? . 6) q render-value)) q (32582 . 8)) ((c def c (c (? . 0) q drracket:get/extend:get-unit-frame)) q (9814 . 3)) ((c meth c (c (? . 11) q get-frame)) q (10597 . 3)) ((c meth c (c (? . 3) q get-user-custodian)) q (55267 . 3)) ((c def c (c (? . 0) q drracket:unit:add-to-program-editor-mixin)) q (19955 . 3)) ((c def c (c (? . 0) q drscheme:language:make-setup-printing-parameters)) q (90575 . 2)) ((c meth c (c (? . 11) q get-directory)) q (10454 . 3)) ((c meth c (c (? . 1) q syncheck:add-background-color)) q (861 . 11)) ((c meth c (c (? . 14) q front-end/complete-program)) q (28245 . 3)) ((c def c (c (? . 0) q drracket:module-language-tools:register-online-expansion-pref)) q (67757 . 4)) ((c meth c (c (? . 6) q marshall-settings)) q (31919 . 4)) ((c meth c (c (? . 4) q file-menu:print-string)) q (13664 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language<%>)) q (69183 . 2)) ((c meth c (c (? . 3) q highlight-errors/exn)) q (55941 . 3)) ((c meth c (c (? . 9) q render-value/format)) q (27156 . 11)) ((c def c (c (? . 0) q drracket:language:make-text/pos)) q (41147 . 8)) ((c def c (c (? . 0) q drscheme:eval:set-basic-parameters)) q (77394 . 4)) ((c def c (c (? . 0) q drscheme:frame:mixin)) q (68997 . 2)) ((c meth c (c (? . 18) q set-filename)) q (18607 . 2)) ((c def c (c (? . 23) q htdp-file-prefix?)) q (7192 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-annotations)) q (42349 . 4)) ((c def c (c (? . 0) q drracket:rep:current-rep)) q (58285 . 3)) ((c meth c (c (? . 3) q on-execute)) q (55028 . 3)) ((c meth c (c (? . 5) q help-menu:about-callback)) q (60542 . 6)) ((c meth c (c (? . 9) q on-execute)) q (26435 . 7)) ((c meth c (c (? . 7) q disable-evaluation)) q (57134 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:fill-language-dialog)) q (46443 . 15)) ((c meth c (c (? . 3) q reset-highlighting)) q (56428 . 2)) ((c meth c (c (? . 3) q wait-for-io-to-complete)) q (56648 . 2)) ((c def c (c (? . 0) q drscheme:debug:profile-tab-mixin)) q (68348 . 2)) ((c meth c (c (? . 6) q get-language-numbers)) q (30696 . 3)) ((c meth c (c (? . 11) q is-current-tab?)) q (10762 . 2)) ((c def c (c (? . 0) q drracket:get/extend:get-interactions-canvas)) q (8886 . 3)) ((c meth c (c (? . 4) q make-searchable)) q (14727 . 3)) ((c meth c (c (? . 12) q render-value/format)) q (24685 . 3)) ((c def c (c (? . 0) q drscheme:eval:expand-program/multiple)) q (79198 . 12)) ((c def c (c (? . 0) q drscheme:rep:get-dark-green-delta)) q (96907 . 2)) ((c def c (? . 12)) q (23399 . 5)) ((c meth c (c (? . 11) q on-close)) q (10890 . 2)) ((c meth c (c (? . 6) q front-end/interaction)) q (30212 . 7)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-tab-mixin)) q (68590 . 2)) ((c def c (c (? . 0) q drscheme:language:module-based-language->language-mixin)) q (69405 . 2)) ((c meth c (c (? . 7) q get-breakables)) q (57387 . 4)) ((c meth c (c (? . 1) q syncheck:find-source-object)) q (739 . 4)) ((c meth c (c (? . 2) q prev-tab)) q (16155 . 2)) ((c meth c (c (? . 4) q get-canvas%)) q (14132 . 2)) ((c meth c (c (? . 16) q update-shown)) q (61674 . 2)) ((c def c (c (? . 0) q drscheme:tracing:tab-mixin)) q (69477 . 2)) ((c meth c (c (? . 9) q get-init-code)) q (25516 . 4)) ((c def c (c (? . 0) q drracket:modes:mode-name)) q (66189 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-printing-style)) q (41543 . 4)) ((c meth c (c (? . 12) q marshall-settings)) q (24340 . 3)) ((c meth c (c (? . 2) q sort-toolbar-buttons-panel)) q (18207 . 3)) ((c meth c (c (? . 2) q ensure-rep-hidden)) q (15501 . 2)) ((c meth c (c (? . 13) q after-delete)) q (12145 . 6)) ((c def c (c (? . 0) q drscheme:language:module-based-language<%>)) q (69124 . 2)) ((c def c (c (? . 0) q drscheme:rep:drs-bindings-keymap-mixin)) q (68870 . 2)) ((c meth c (c (? . 13) q after-insert)) q (12325 . 6)) ((c meth c (c (? . 3) q after-insert)) q (54431 . 2)) ((c meth c (c (? . 5) q file-menu:open-callback)) q (60139 . 6)) ((c def c (? . 9)) q (25066 . 2)) ((c def c (c (? . 0) q drscheme:language:create-module-based-distribution)) q (89281 . 5)) ((c meth c (c (? . 2) q get-language-menu)) q (15355 . 3)) ((c def c (c (? . 0) q drracket:language:text/pos-start)) q (40683 . 3)) ((c def c (c (? . 0) q drscheme:frame:basics<%>)) q (69811 . 2)) ((c constructor c (? . 10)) q (21576 . 18)) ((c def c (c (? . 0) q drracket:modes:get-modes)) q (66116 . 2)) ((c meth c (c (? . 14) q on-execute)) q (28628 . 3)) ((c def c (c (? . 0) q drscheme:module-language-tools:tab-mixin)) q (69684 . 2)) ((c meth c (c (? . 4) q get-break-button)) q (13881 . 3)) ((c meth c (c (? . 11) q break-callback)) q (9990 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-definitions-text)) q (8021 . 7)) ((c meth c (c (? . 4) q on-close)) q (14861 . 2)) ((c def c (c (? . 0) q drracket:language:capability-registered?)) q (33771 . 3)) ((c constructor c (? . 20)) q (12592 . 3)) ((c meth c (c (? . 4) q get-text-to-search)) q (14637 . 3)) ((c meth c (c (? . 11) q set-breakables)) q (11010 . 5)) ((c def c (c (? . 0) q drracket:language:setup-printing-parameters)) q (40089 . 7)) ((c def c (c (? . 0) q drracket:modes:mode-surrogate)) q (66279 . 4)) ((c def c (c (? . 0) q drracket:debug:profile-definitions-text-mixin)) q (47627 . 4)) ((c def c (c (? . 0) q drscheme:get/extend:get-unit-frame)) q (82864 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:get-settings-preferences-symbol)) q (83687 . 2)) ((c meth c (c (? . 6) q get-metadata)) q (31000 . 6)) ((c form c (c (? . 8) q syncheck:add-arrow)) q (6629 . 2)) ((c def c (? . 14)) q (28025 . 5)) ((c def c (c (? . 0) q drracket:language:text/pos)) q (40984 . 6)) ((c def c (c (? . 0) q drscheme:module-language-tools:frame-mixin)) q (69625 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:add-language)) q (83312 . 5)) ((c form c (c (? . 8) q syncheck:add-docs-menu)) q (6567 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-definitions-text)) q (81513 . 2)) ((c meth c (c (? . 3) q display-results)) q (54491 . 3)) ((c meth c (c (? . 15) q get-one-line-summary)) q (21166 . 3)) ((c meth c (c (? . 6) q get-reader-module)) q (31350 . 3)) ((c meth c (c (? . 21) q get-users-language-name)) q (67964 . 3)) ((c def c (c (? . 0) q drracket:language:get-capability-default)) q (33859 . 4)) ((c def c (c (? . 0) q drscheme:language:get-default-mixin)) q (87520 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:tab<%>)) q (70120 . 2)) ((c meth c (c (? . 10) q get-one-line-summary)) q (23155 . 3)) ((c meth c (c (? . 3) q get-user-eventspace)) q (55356 . 3)) ((c meth c (c (? . 9) q get-reader)) q (26053 . 3)) ((c meth c (c (? . 5) q file-menu:new-callback)) q (59848 . 6)) ((c def c (c (? . 0) q drscheme:unit:interactions-canvas%)) q (68819 . 2)) ((c meth c (c (? . 19) q get-tab)) q (19217 . 3)) ((c def c (c (? . 0) q drracket:rep:get-welcome-delta)) q (58065 . 2)) ((c def c (c (? . 0) q drscheme:rep:text<%>)) q (68960 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:language-dialog)) q (45855 . 9)) ((c def c (c (? . 0) q drscheme:unit:frame<%>)) q (69887 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-definitions-canvas)) q (8998 . 7)) ((c meth c (c (? . 1) q syncheck:color-range)) q (5855 . 12)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings-settings)) q (45370 . 4)) ((c meth c (c (? . 4) q get-definitions/interactions-panel-parent)) q (14206 . 5)) ((c meth c (c (? . 3) q on-close)) q (56220 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-settings?)) q (93136 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-tab)) q (80504 . 4)) ((c def c (? . 16)) q (61131 . 5)) ((c def c (c (? . 0) q drracket:language:create-module-based-distribution)) q (37371 . 17)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-interactions-text-mixin)) q (68453 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language->module-based-language-mixin)) q (69313 . 2)) ((c meth c (c (? . 5) q help-menu:about-string)) q (60763 . 3)) ((c meth c (c (? . 11) q is-running?)) q (10828 . 2)) ((c meth c (c (? . 6) q unmarshall-settings)) q (33319 . 4)) ((c meth c (c (? . 14) q get-language-name)) q (28528 . 3)) ((c def c (c (? . 0) q drscheme:frame:basics-mixin)) q (69034 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-settings->vector)) q (94416 . 3)) ((c meth c (c (? . 16) q add-show-menu-items)) q (61282 . 3)) ((c def c (c (? . 0) q drracket:debug:open-and-highlight-in-file)) q (48843 . 11)) ((c meth c (c (? . 2) q get-definitions-canvas)) q (16280 . 3)) ((c def c (c (? . 0) q drscheme:language:put-executable)) q (87704 . 7)) ((c meth c (c (? . 6) q get-one-line-summary)) q (31270 . 3)) ((c def c (c (? . 0) q drscheme:language:get-capability-default)) q (86550 . 4)) ((c meth c (c (? . 6) q capability-value)) q (28774 . 3)) ((c meth c (c (? . 2) q register-toolbar-button)) q (17399 . 7)) ((c def c (c (? . 0) q drscheme:debug:profile-definitions-text-mixin)) q (68286 . 2)) ((c meth c (c (? . 11) q enable-evaluation)) q (10179 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-interactions-canvas)) q (81625 . 5)) ((c meth c (c (? . 6) q get-language-url)) q (30907 . 3)) ((c meth c (c (? . 2) q get-interactions-text)) q (16708 . 3)) ((c def c (? . 17)) q (11746 . 4)) ((c meth c (c (? . 2) q ensure-rep-shown)) q (15568 . 2)) ((c meth c (c (? . 3) q shutdown)) q (56592 . 2)) ((c constructor c (? . 17)) q (11842 . 3)) ((c def c (c (? . 8) q current-annotations)) q (510 . 5)) ((c def c (c (? . 0) q drracket:rep:get-drs-bindings-keymap)) q (58212 . 2)) ((c meth c (c (? . 11) q get-defs)) q (10358 . 3)) ((c def c (c (? . 0) q drscheme:language:text/pos-end)) q (90913 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-annotations)) q (92879 . 4)) ((c def c (c (? . 0) q drscheme:unit:tab%)) q (68645 . 2)) ((c meth c (c (? . 6) q default-settings?)) q (29537 . 4)) ((c def c (c (? . 0) q drscheme:unit:get-program-editor-mixin)) q (127770 . 3)) ((c meth c (c (? . 16) q get-show-menu)) q (61604 . 2)) ((c def c (? . 18)) q (18284 . 5)) ((c def c (c (? . 0) q drracket:language:simple-settings-show-sharing)) q (42046 . 4)) ((c def c (c (? . 0) q drracket:debug:hide-backtrace-window)) q (48729 . 2)) ((c def c (c (? . 0) q drscheme:debug:add-prefs-panel)) q (71055 . 2)) ((c def c (c (? . 0) q drracket:language:make-setup-printing-parameters)) q (40410 . 3)) ((c meth c (c (? . 6) q create-executable)) q (29021 . 9)) ((c meth c (c (? . 2) q get-tab-filename)) q (15726 . 3)) ((c meth c (c (? . 3) q reset-console)) q (56367 . 2)) ((c def c (c (? . 0) q drscheme:unit:add-search-help-desk-menu-item)) q (128238 . 2)) ((c def c (c (? . 0) q drracket:language-configuration:get-languages)) q (44308 . 3)) ((c form c (c (? . 8) q syncheck:add-jump-to-definition)) q (6724 . 2)) ((c meth c (c (? . 4) q get-canvas)) q (14051 . 3)) ((c meth c (c (? . 19) q end-metadata-changes)) q (19044 . 3)) ((c meth c (c (? . 4) q file-menu:between-print-and-close)) q (13494 . 3)) ((c meth c (c (? . 9) q unmarshall-settings)) q (27693 . 4)) ((c def c (c (? . 0) q drscheme:language:create-distribution-for-executable)) q (89609 . 6)) ((c def c (c (? . 0) q drracket:language:text/pos-text)) q (40562 . 3)) ((c def c (c (? . 0) q drracket:eval:expand-program/multiple)) q (64057 . 18)) ((c meth c (c (? . 11) q get-ints)) q (10681 . 3)) ((c meth c (c (? . 4) q get-button-panel)) q (13961 . 3)) ((c def c (c (? . 0) q drscheme:module-language-tools:add-opt-out-toolbar-button)) q (95438 . 7)) ((c meth c (c (? . 4) q execute-callback)) q (13344 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-interactions-text)) q (7570 . 7)) ((c meth c (c (? . 5) q help-menu:before-about)) q (60840 . 4)) ((c meth c (c (? . 6) q front-end/finished-complete-program)) q (30085 . 4)) ((c form c (c (? . 8) q syncheck:add-require-open-menu)) q (6529 . 2)) ((c meth c (c (? . 7) q needs-execution)) q (57588 . 3)) ((c def c (? . 20)) q (12505 . 3)) ((c def c (c (? . 0) q drscheme:modes:mode-surrogate)) q (95103 . 3)) ((c meth c (c (? . 3) q evaluate-from-port)) q (54594 . 9)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings-settings)) q (84205 . 3)) ((c meth c (c (? . 3) q wait-for-io-to-complete/user)) q (56719 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:fill-language-dialog)) q (85265 . 10)) ((c def c (c (? . 0) q drscheme:unit:frame%)) q (68680 . 2)) ((c def c (c (? . 0) q drscheme:debug:open-and-highlight-in-file)) q (71108 . 8)) ((c meth c (c (? . 12) q default-settings?)) q (23933 . 3)) ((c def c (c (? . 0) q drracket:language:get-default-mixin)) q (34855 . 3)) ((c def c (? . 21)) q (67902 . 2)) ((c def c (? . 19)) q (18753 . 2)) ((c def c (c (? . 0) q drracket:get/extend:get-definitions-canvas)) q (9376 . 3)) ((c def c (c (? . 0) q drscheme:debug:error-display-handler/stacktrace)) q (70230 . 7)) ((c def c (c (? . 0) q drscheme:module-language:module-language-put-file-mixin)) q (96693 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-settings-printing-style)) q (91664 . 4)) ((c def c (c (? . 0) q drscheme:language:add-snip-value)) q (87021 . 5)) ((c meth c (c (? . 18) q set-modified)) q (18680 . 2)) ((c meth c (c (? . 2) q get-interactions-canvas)) q (16576 . 3)) ((c def c (? . 5)) q (59325 . 4)) ((c def c (c (? . 0) q drracket:language:create-module-based-launcher)) q (38817 . 17)) ((c def c (c (? . 0) q drracket:module-language-tools:add-online-expansion-handler)) q (67233 . 11)) ((c def c (c (? . 0) q drscheme:language:get-language-extensions)) q (87625 . 2)) ((c meth c (c (? . 4) q file-menu:save-string)) q (13810 . 2)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language-convert-value)) q (90312 . 2)) ((c def c (c (? . 0) q drracket:language:simple-settings->vector)) q (44164 . 4)) ((c meth c (c (? . 6) q get-metadata-lines)) q (31193 . 3)) ((c def c (c (? . 0) q drracket:rep:text<%>)) q (54079 . 2)) ((c meth c (c (? . 3) q after-delete)) q (54371 . 2)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window)) q (75556 . 8)) ((c def c (c (? . 0) q drscheme:rep:current-value-port)) q (97141 . 2)) ((c meth c (c (? . 9) q use-mred-launcher)) q (27833 . 3)) ((c def c (c (? . 0) q drscheme:unit:tab<%>)) q (69976 . 2)) ((c def c (c (? . 0) q drscheme:debug:profile-unit-frame-mixin)) q (68397 . 2)) ((c meth c (c (? . 3) q get-user-language-settings)) q (55447 . 3)) ((c meth c (c (? . 5) q file-menu:new-string)) q (60065 . 2)) ((c def c (c (? . 0) q drracket:get/extend:get-definitions-text)) q (8393 . 3)) ((c meth c (c (? . 15) q get-module)) q (21071 . 3)) ((c def c (c (? . 0) q drracket:module-language:add-module-language)) q (68053 . 2)) ((c constructor c (? . 22)) q (58703 . 4)) ((c meth c (c (? . 11) q reset-offer-kill)) q (10946 . 2)) ((c def c (c (? . 0) q drscheme:eval:traverse-program/multiple)) q (78370 . 11)) ((c meth c (c (? . 6) q first-opened)) q (29651 . 4)) ((c def c (c (? . 0) q drscheme:get/extend:extend-interactions-text)) q (80756 . 4)) ((c def c (? . 15)) q (20745 . 2)) ((c def c (? . 7)) q (57017 . 2)) ((c def c (c (? . 0) q drscheme:language:text/pos-text)) q (90725 . 3)) ((c def c (c (? . 0) q drscheme:debug:test-coverage-definitions-text-mixin)) q (68522 . 2)) ((c def c (? . 24)) q (56796 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-show-sharing)) q (92446 . 4)) ((c def c (c (? . 0) q drracket:language:put-executable)) q (35043 . 12)) ((c def c (c (? . 0) q drscheme:modes:get-modes)) q (94956 . 2)) ((c def c (c (? . 0) q drscheme:language:create-module-based-launcher)) q (89966 . 4)) ((c meth c (c (? . 15) q get-language-position)) q (20945 . 3)) ((c def c (c (? . 0) q drscheme:rep:get-drs-bindings-keymap)) q (96981 . 2)) ((c meth c (c (? . 19) q set-next-settings)) q (19424 . 7)) ((c def c (c (? . 0) q drscheme:language:make-text/pos)) q (91300 . 4)) ((c meth c (c (? . 3) q get-error-range)) q (55141 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-fraction-style)) q (41752 . 7)) ((c def c (c (? . 0) q drscheme:language:text/pos)) q (91065 . 4)) ((c def c (c (? . 0) q drracket:frame:basics<%>)) q (61040 . 3)) ((c meth c (c (? . 2) q create-new-tab)) q (16033 . 2)) ((c meth c (c (? . 9) q get-language-position)) q (25753 . 3)) ((c meth c (c (? . 6) q render-value/format)) q (32847 . 11)) ((c meth c (c (? . 4) q break-callback)) q (13101 . 2)) ((c form c (c (? . 8) q syncheck:find-source-object)) q (6457 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:extend-unit-frame)) q (82591 . 4)) ((c meth c (c (? . 7) q get-directory)) q (57504 . 3)) ((c def c (? . 10)) q (21422 . 4)) ((c def c (c (? . 0) q drscheme:language:create-module-based-stand-alone-executable)) q (88913 . 5)) ((c meth c (c (? . 4) q update-save-button)) q (15045 . 4)) ((c meth c (c (? . 6) q on-execute)) q (32147 . 7)) ((c meth c (c (? . 11) q get-enabled)) q (10535 . 2)) ((c meth c (c (? . 3) q initialize-console)) q (56030 . 2)) ((c def c (c (? . 0) q drracket:language:text/pos-end)) q (40796 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:get-languages)) q (83199 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:register-online-expansion-pref)) q (96503 . 2)) ((c meth c (c (? . 3) q run-in-evaluation-thread)) q (56494 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings?)) q (42546 . 3)) ((c def c (c (? . 0) q drscheme:unit:open-drscheme-window)) q (128000 . 4)) ((c def c (c (? . 0) q drracket:help-desk:help-desk)) q (61732 . 6)) ((c def c (c (? . 0) q drscheme:tracing:frame-mixin)) q (69520 . 2)) ((c meth c (c (? . 4) q file-menu:between-save-as-and-print)) q (13578 . 3)) ((c meth c (c (? . 9) q render-value)) q (26779 . 9)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window/edition-pairs/two)) q (50639 . 33)) ((c form c (c (? . 8) q syncheck:add-tail-arrow)) q (6655 . 2)) ((c def c (c (? . 0) q drracket:modes:mode-repl-submit)) q (66418 . 3)) ((c meth c (c (? . 2) q on-tab-change)) q (16899 . 5)) ((c meth c (c (? . 6) q get-language-position)) q (30801 . 3)) ((c def c (c (? . 0) q drracket:language-configuration:add-language)) q (44423 . 8)) ((c form c (c (? . 25) q syncheck:button-callback)) q (7065 . 2)) ((c meth c (c (? . 9) q marshall-settings)) q (26308 . 4)) ((c def c (c (? . 0) q drscheme:debug:srcloc->edition/pair)) q (76143 . 12)) ((c meth c (c (? . 11) q disable-evaluation)) q (10113 . 2)) ((c def c (c (? . 0) q drracket:module-language:module-language-put-file-mixin)) q (68119 . 4)) ((c form c (c (? . 8) q syncheck:color-range)) q (6763 . 2)) ((c def c (c (? . 0) q drracket:language:extend-language-interface)) q (34503 . 7)) ((c def c (c (? . 0) q drracket:language:simple-settings)) q (42630 . 14)) ((c meth c (c (? . 6) q get-language-name)) q (30619 . 3)) ((c def c (c (? . 8) q annotations-mixin)) q (6358 . 3)) ((c def c (c (? . 0) q drscheme:module-language:module-language<%>)) q (69565 . 2)) ((c meth c (c (? . 12) q render-value)) q (24572 . 3)) ((c def c (c (? . 0) q drracket:eval:build-user-eventspace/custodian)) q (64948 . 11)) ((c meth c (c (? . 22) q set-message)) q (58857 . 6)) ((c def c (c (? . 0) q drscheme:get/extend:get-interactions-text)) q (81050 . 2)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings)) q (83775 . 6)) ((c meth c (c (? . 9) q get-transformer-module)) q (26190 . 3)) ((c meth c (c (? . 4) q update-shown)) q (15245 . 2)) ((c meth c (c (? . 4) q file-menu:between-open-and-revert)) q (13410 . 3)) ((c meth c (c (? . 12) q on-execute)) q (24461 . 3)) ((c meth c (c (? . 2) q next-tab)) q (16097 . 2)) ((c def c (c (? . 0) q drscheme:module-language-tools:definitions-text<%>)) q (70053 . 2)) ((c def c (c (? . 0) q drscheme:modes:mode-matches-language)) q (95304 . 3)) ((c meth c (c (? . 12) q get-transformer-module)) q (24210 . 3)) ((c def c (c (? . 0) q drscheme:language-configuration:language-settings?)) q (84812 . 3)) ((c meth c (c (? . 11) q get-breakables)) q (10244 . 4)) ((c def c (c (? . 0) q drscheme:unit:get-definitions-text%)) q (68767 . 2)) ((c def c (c (? . 0) q drscheme:debug:show-backtrace-window/edition-pairs/two)) q (73211 . 25)) ((c def c (c (? . 0) q drracket:rep:get-dark-green-delta)) q (58137 . 2)) ((c meth c (c (? . 2) q ensure-defs-shown)) q (15434 . 2)) ((c def c (c (? . 0) q drracket:debug:error-display-handler/stacktrace)) q (47812 . 14)) ((c meth c (c (? . 1) q syncheck:add-arrow)) q (3170 . 19)) ((c def c (c (? . 0) q drracket:language-configuration:language-settings-language)) q (45519 . 5)) ((c meth c (c (? . 12) q get-init-code)) q (24054 . 4)) ((c meth c (c (? . 3) q kill-evaluation)) q (56157 . 2)) ((c def c (c (? . 0) q drscheme:modes:mode?)) q (94899 . 2)) ((c meth c (c (? . 9) q config-panel)) q (25134 . 4)) ((c def c (c (? . 0) q drracket:unit:get-program-editor-mixin)) q (19845 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings)) q (93207 . 8)) ((c meth c (c (? . 7) q set-breakables)) q (57741 . 5)) ((c def c (? . 11)) q (9903 . 3)) ((c def c (c (? . 0) q drracket:language:create-distribution-for-executable)) q (38359 . 9)) ((c meth c (c (? . 7) q update-running)) q (57967 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-module-based-language%)) q (69249 . 2)) ((c meth c (c (? . 12) q config-panel)) q (23659 . 3)) ((c def c (c (? . 0) q drscheme:eval:get-snip-classes)) q (77608 . 2)) ((c meth c (c (? . 11) q add-bkg-running-color)) q (11232 . 7)) ((c def c (c (? . 0) q drracket:debug:profile-interactions-text-mixin)) q (47492 . 3)) ((c def c (c (? . 0) q drscheme:language:setup-printing-parameters)) q (90436 . 2)) ((c meth c (c (? . 4) q get-editor)) q (14404 . 2)) ((c def c (c (? . 0) q drracket:language:simple-module-based-language-convert-value)) q (39771 . 7)) ((c def c (c (? . 0) q drracket:debug:srcloc->edition/pair)) q (53068 . 16)) ((c meth c (c (? . 11) q get-last-touched)) q (11680 . 2)) ((c def c (? . 3)) q (54125 . 4)) ((c meth c (c (? . 11) q can-close?)) q (10052 . 2)) ((c def c (c (? . 0) q drscheme:language:capability-registered?)) q (86475 . 2)) ((c meth c (c (? . 1) q syncheck:add-jump-to-definition)) q (5222 . 13)) ((c def c (c (? . 0) q drscheme:rep:context<%>)) q (70013 . 2)) ((c def c (c (? . 0) q drracket:language:object/c)) q (33446 . 2)) ((c meth c (c (? . 4) q file-menu:save-as-string)) q (13736 . 2)) ((c constructor c (? . 3)) q (54226 . 4)) ((c def c (c (? . 0) q drscheme:get/extend:extend-definitions-text)) q (81150 . 5)) ((c def c (c (? . 0) q drscheme:eval:build-user-eventspace/custodian)) q (80067 . 6)) ((c def c (? . 4)) q (12721 . 5)) ((c meth c (c (? . 3) q get-user-thread)) q (55623 . 3)) ((c def c (c (? . 0) q drscheme:language:create-executable-gui)) q (88086 . 10)) ((c def c (c (? . 0) q drracket:rep:current-value-port)) q (58375 . 2)) ((c meth c (c (? . 1) q syncheck:add-rename-menu)) q (2656 . 9)) ((c def c (c (? . 0) q drscheme:language:text/pos-start)) q (90823 . 3)) ((c def c (c (? . 0) q drscheme:debug:make-debug-error-display-handler)) q (70794 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-insert-newlines)) q (92658 . 4)) ((c meth c (c (? . 4) q get-execute-button)) q (14555 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-case-sensitive)) q (41391 . 4)) ((c def c (c (? . 0) q drscheme:rep:after-expression)) q (97212 . 873)) ((c meth c (c (? . 9) q get-one-line-summary)) q (25960 . 3)) ((c def c (c (? . 0) q drracket:modes:mode?)) q (66046 . 3)) ((c def c (c (? . 0) q drracket:language:simple-settings-insert-newlines)) q (42196 . 4)) ((c meth c (c (? . 19) q set-needs-execution-message)) q (19310 . 4)) ((c meth c (c (? . 9) q use-namespace-require/copy?)) q (27924 . 3)) ((c def c (c (? . 0) q drscheme:debug:hide-backtrace-window)) q (70996 . 2)) ((c meth c (c (? . 17) q clear-annotations)) q (11924 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-definitions-canvas)) q (82483 . 2)) ((c def c (c (? . 0) q drscheme:rep:text%)) q (68925 . 2)) ((c meth c (c (? . 10) q get-reader)) q (23255 . 3)) ((c meth c (c (? . 5) q edit-menu:between-find-and-preferences)) q (59493 . 3)) ((c form c (c (? . 8) q syncheck:add-mouse-over-status)) q (6686 . 2)) ((c meth c (c (? . 4) q update-save-message)) q (15149 . 3)) ((c meth c (c (? . 15) q get-reader)) q (21278 . 3)) ((c def c (c (? . 0) q drscheme:frame:<%>)) q (69852 . 2)) ((c def c (c (? . 0) q drracket:eval:set-basic-parameters)) q (62002 . 7)) ((c meth c (c (? . 7) q ensure-rep-shown)) q (57271 . 3)) ((c def c (c (? . 0) q drracket:modes:add-mode)) q (65573 . 10)) ((c def c (c (? . 0) q drscheme:module-language-tools:definitions-text-mixin)) q (69741 . 2)) ((c form c (c (? . 8) q syncheck:add-background-color)) q (6492 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-tab)) q (7263 . 7)) ((c meth c (c (? . 6) q metadata->settings)) q (32033 . 4)) ((c meth c (c (? . 3) q insert-prompt)) q (56096 . 2)) ((c meth c (c (? . 6) q get-style-delta)) q (31469 . 3)) ((c def c (c (? . 0) q drracket:language:register-capability)) q (33493 . 7)) ((c meth c (c (? . 19) q get-next-settings)) q (19126 . 3)) ((c meth c (c (? . 14) q front-end/interaction)) q (28389 . 3)) ((c def c (c (? . 0) q drracket:debug:show-backtrace-window/edition-pairs)) q (49517 . 21)) ((c def c (c (? . 23) q htdp-save-file-prefix)) q (7142 . 2)) ((c meth c (c (? . 7) q enable-evaluation)) q (57203 . 2)) ((c def c (c (? . 0) q drscheme:modes:mode-name)) q (95028 . 2)) ((c meth c (c (? . 2) q close-current-tab)) q (16213 . 2)) ((c meth c (c (? . 4) q add-show-menu-items)) q (12985 . 4)) ((c def c (c (? . 0) q drscheme:language-configuration:language-dialog)) q (84899 . 4)) ((c constructor c (? . 18)) q (18507 . 3)) ((c meth c (c (? . 2) q get-definitions-text)) q (16392 . 3)) ((c meth c (c (? . 24) q get-keymaps)) q (56919 . 3)) ((c def c (c (? . 0) q drracket:language:get-language-extensions)) q (34962 . 3)) ((c meth c (c (? . 19) q after-set-next-settings)) q (18812 . 4)) ((c def c (c (? . 0) q drracket:debug:profile-unit-frame-mixin)) q (47311 . 4)) ((c def c (c (? . 0) q drscheme:module-language:add-module-language)) q (96628 . 2)) ((c meth c (c (? . 6) q get-comment-character)) q (30531 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-case-sensitive)) q (91550 . 3)) ((c def c (c (? . 0) q drscheme:language:register-capability)) q (86119 . 6)) ((c meth c (c (? . 11) q touched)) q (11625 . 2)) ((c def c (c (? . 0) q drscheme:get/extend:get-interactions-canvas)) q (82002 . 2)) ((c meth c (c (? . 6) q front-end/complete-program)) q (29757 . 7)) ((c def c (c (? . 0) q drracket:language:create-module-based-stand-alone-executable)) q (36305 . 17)) ((c def c (c (? . 0) q drracket:module-language-tools:add-opt-out-toolbar-button)) q (66661 . 11)) ((c meth c (c (? . 2) q get-tabs)) q (16804 . 3)) ((c meth c (c (? . 2) q register-capability-menu-item)) q (17129 . 7)) ((c def c (? . 22)) q (58632 . 3)) ((c def c (c (? . 0) q drscheme:module-language-tools:frame<%>)) q (70174 . 2)) ((c meth c (c (? . 6) q default-settings)) q (29460 . 3)) ((c meth c (c (? . 2) q get-tab-count)) q (15834 . 3)) ((c meth c (c (? . 16) q set-show-menu-sort-key)) q (61393 . 5)) ((c meth c (c (? . 1) q syncheck:add-tail-arrow)) q (4148 . 11)) ((c meth c (c (? . 2) q unregister-toolbar-button)) q (18086 . 4)) ((c meth c (c (? . 6) q extra-repl-information)) q (31635 . 7)) ((c meth c (c (? . 4) q still-untouched?)) q (14976 . 2)) ((c def c (c (? . 0) q drracket:frame:mixin)) q (59070 . 6)) ((c def c (c (? . 0) q drscheme:rep:current-rep)) q (97053 . 2)) ((c def c (? . 6)) q (28719 . 2)) ((c def c (c (? . 0) q drscheme:unit:definitions-text<%>)) q (69926 . 2)) ((c def c (c (? . 0) q drracket:get/extend:extend-unit-frame)) q (9486 . 7)) ((c def c (c (? . 0) q drracket:language-configuration:get-settings-preferences-symbol)) q (44943 . 3)) ((c meth c (c (? . 19) q begin-metadata-changes)) q (18960 . 3)) ((c def c (c (? . 0) q drscheme:eval:expand-program)) q (77688 . 11)) ((c def c (c (? . 25) q syncheck-bitmap)) q (7097 . 2)) ((c meth c (c (? . 12) q default-settings)) q (23813 . 3)) ((c meth c (c (? . 12) q unmarshall-settings)) q (24805 . 3)) ((c def c (? . 2)) q (15307 . 2)) ((c meth c (c (? . 3) q queue-output)) q (56276 . 3)) ((c def c (c (? . 25) q syncheck-drracket-button)) q (6791 . 7)) ((c def c (c (? . 0) q drracket:unit:add-search-help-desk-menu-item)) q (20306 . 9)) ((c meth c (c (? . 5) q help-menu:create-about?)) q (60961 . 3)) ((c def c (c (? . 0) q drscheme:language:simple-settings-fraction-style)) q (91939 . 7)) ((c def c (c (? . 0) q drracket:language:create-executable-gui)) q (35558 . 13)) ((c def c (c (? . 0) q drscheme:modes:add-mode)) q (94522 . 7)) ((c meth c (c (? . 9) q default-settings?)) q (25389 . 4)) ((c def c (c (? . 0) q drscheme:rep:get-welcome-delta)) q (96836 . 2)) ((c meth c (c (? . 4) q edit-menu:between-select-all-and-find)) q (13256 . 3)) ((c def c (c (? . 0) q drscheme:language:text/pos?)) q (91001 . 2))))
procedure
...
value
drscheme:language-configuration:language-settings : ((or/c (is-a?/c drracket:language:language<%>)
                                                           drracket:language:object/c)
                                                     any/c
                                                     . -> .
                                                     drracket:language-configuration:language-settings?)
...
drscheme:language-configuration:language-settings-settings : (-> drracket:language-configuration:language-settings?
                                                                 any/c)
value
drscheme:language-configuration:language-settings-language : (drracket:language-configuration:language-settings?
                                                              . -> .
                                                              (or/c (is-a?/c drracket:language:language<%>)
                                                                    drracket:language:object/c))
value
...
value
drscheme:language:text/pos-text : (drracket:language:text/pos? . ->
. (is-a?/c text%))
value
drscheme:language:text/pos-start : (drracket:language:text/pos? . ->
. number?)
value
drscheme:language:text/pos-end : (drracket:language:text/pos? . ->
. number?)
value
drscheme:language:text/pos? : (any/c . -> . boolean?)
value
drscheme:language:text/pos : ((is-a?/c text%) number? number?
                                              . -> .
                                              drracket:language:text/pos?)
value
...
value
drscheme:modes:mode-surrogate : (drracket:modes:mode? . ->
. (or/c false/c (is-a?/c mode:surrogate-text<%>)))
value
drscheme:modes:mode-repl-submit : (drracket:modes:mode? . -> . any)
value
drscheme:modes:mode-matches-language : (drracket:modes:mode? . ->
. ((or/c false/c (listof string?)) . -> . boolean?))
value
...
value
drscheme:rep:after-expression : (parameter/c
                                 
                                 
                                 
                                 
